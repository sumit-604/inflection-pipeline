...
| 4 | Coal handling beyond MCL — GSECL | New order won | — | **GSECL Ukai Rs 187.6 Cr won, work commenced** (deck L232) | **GREEN** |
...
| Coal handling beyond MCL (GSECL) | Low | **Rs 187.6 Cr GSECL order won, work commenced** | — | **FIRED (order-level)** |
...
| Growth Visibility Premium | +(embedded, EM 28) | GSECL order GREEN; catalysts intact but early | HOLD |
...
| UA Multiplier | per Amendment 3 (if applied) | No change in the three qualifiers this quarter | HOLD |
...
| GSECL Ukai coal-handling plant Rs 187.6 Cr — execution | FY27 | deck slide 8 L232-233 | commenced (GREEN) |
...
monitorables:
  ...
  - {item: "GSECL Ukai coal-handling plant Rs 187.6 Cr execution", implied_date: "FY27", source_ref: "deck slide 8 L232-233"}
