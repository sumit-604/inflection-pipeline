# COMPANY MEMORY — Azad Engineering Ltd (AZAD)

BSE 544061 / NSE AZAD | Precision engineering: mission/life-critical airfoils, blades, 3D rotating parts for energy turbines, aerospace and defence, oil and gas OEMs. Founder Rakesh Chopdar, Hyderabad. IPO Dec 2023.
...
- Working capital days failing to fall from 344 toward the 160-170 day target through FY27.
- Revenue growth below 25% YoY for two consecutive quarters.
- Top-1 customer crossing about 20% or top-5 crossing 65% of revenue.
- New adverse SEBI order on the open PIT Code of Conduct matter, or an auditor / independent director exit.

## OPTIONALITY REGISTER (summary)
- Saudi Arabia Baker Hughes facility → converts on a signed definitive facility/JV agreement with committed capex; appears in an exchange filing / concall; window FY28+ (already slipped once).
- Safran Aircraft Engines relationship → converts on a firm signed contract with disclosed value; exchange filing / concall; window FY27.
- GTRE/ATGG indigenous jet engine → converts on actual physical delivery to DRDO with follow-on order visibility; concall / order announcement; window uncertain (slipped 3 consecutive quarters).
- Phase 2 capacity expansion (67,267 sq.m) → converts on a civil-work-start announcement with committed capex; window FY28+.
- Higher-value product lines (advanced gas/steam/nuclear turbines, landing gears) → converts on a signed contract or committed capex; window FY28+.

## RUN FOLDERS
- runs/azad-2026-07-12/
