# STAGE 6: PEER CONCALL VERIFICATION — KABRAEXTRU (RERUN 3)

**Main company:** Kabra Extrusion Technik Ltd (KABRAEXTRU) | **Run date of record:** 2026-09-05
**This run:** Rerun 3 of this stage. Run 1 aborted mid-read on an API error. Run 2 (preserved
at `runs/kabraextru-2026-09-05/outputs/reports/06-peers-run1.md`) completed but was audited by
two independent verifiers (Verifier B, peer utilisation 83.0; Verifier D, 1 MAJOR + 7 MINOR page
offsets), and the pipeline verdict on that run was REWORK. This rerun was ordered 2026-09-09 to
execute the fix list in `runs/kabraextru-2026-09-05/outputs/final/run1/gate-recommendation.md`
("What a rerun must fix," items 5, 11, 12, 14, plus the Claim 7/8 HBL investment-scale contrast).
...
newest peer data point and the claim window is roughly 18 months. No RAJOOENG transcript says
anything about FY26 itself. Every verdict below that touches the FY26 window is capped by this
gap: peer evidence up to Oct-2024 can complicate or contradict the FRAMING of KABRAEXTRU's
explanation (is this kind of industry-wide weakness plausible at all, based on the closest
available peer data), but it cannot directly confirm or deny the FY26 figures themselves. That
distinction is kept explicit in every row, and in the summary table below, not only in a
footnote.

The single HBLENGINE document is a 25-Sep-2025 Annual General Meeting transcript, not an
earnings call. HBL Engineering is a diversified defence-electronics and battery company; its
lithium-ion activity is deliberately confined to Navy defence cells, not EV battery packs. It
remains a weak segment fit for Geon (KABRAEXTRU's EV battery-pack division). This rerun draws one
new, explicit quantitative contrast from that transcript (Claims 7-8 below) while keeping the
weak-fit label attached to it.

Windsor Machines (WINDMACHIN) has **no transcript in the corpus**. Run 2 listed it UNUSED. That
was true but incomplete: `runs/kabraextru-2026-09-05/inputs/screening/WINDMACHIN-Data_Sheet.csv`
is in corpus, reaches the FY26 window and the June-2026 quarter, and was never used or even
caveated out in run 2. This rerun uses it, exactly as screener data, unanchored to any filed
disclosure or management commentary, against Claims 1, 5 and 6 only, with an explicit statement
of what it can and cannot show. Coverage map usage changes from UNUSED to CITED-ONLY.

---

## PART 1: CLAIM-BY-CLAIM VERIFICATION

### Claim 1 — External-blame framing for the 13.2% extrusion segment decline
...
| Field | Content |
|---|---|
| Claim | KABRAEXTRU's own cited global extrusion machinery CAGR nearly doubled between AR FY25 (3.9%, USD 6.9bn→10bn by 2030) and AR FY26 (6.7%, USD 7.74bn→12.22bn by 2032), with no source reconciliation given by the company. |
| Verdict | **PARTIALLY VERIFIED** (direction corroborated at the lower end; magnitude of the 6.7% figure not corroborated). Unchanged from run 2; anchors re-verified, no offset found. |
| Peer evidence | RAJOOENG, Q2 FY24, 6-Nov-2023, PDF p.3: "The global extrusion machinery market is expected to grow from $7.31 billion in 2022 to $7.65 billion in 2023 at a compound annual growth rate of 4.6% CAGR. The extrusion machinery market is expected to grow to $9.02 billion in 2027 at the CAGR of 4.2%." RAJOOENG, Q4 FY24, 18-Apr-2024, PDF p.2: "Global extrusion machinery market size was estimated at USD 8.33 billion in 22 and is expected to reach 11.6 billion USD by 2030" (implied CAGR ≈4.2%, computed from the two data points given). |
| Peers silent | HBLENGINE, WINDMACHIN (not asked; different industry / no transcript). |
| Net read | Across two calls seven months apart, RAJOOENG's cited global CAGR held stable at 4.2%-4.6%, sitting closer to KABRAEXTRU's own FY25 figure (3.9%) than its FY26 figure (6.7%). The peer never cites anything near 6.7% in any of its four calls. This does not prove KABRAEXTRU's 6.7% figure wrong (different research-house sourcing, different base year, and the calls stop 18 months before AR FY26 was written), but it means the peer data lends no support to the higher figure and mildly corroborates the lower one. |

### Claim 3 — ~40% extrusion machinery market share, dropped from AR FY26

| Field | Content |
|---|---|
| Claim | KABRAEXTRU claimed "~40% market share" in AR FY25 (repeating a Dec-2023 deck claim); the figure is absent entirely from AR FY26, alongside a 13.2% segment revenue decline, with no explanation given. |
| Verdict | **PARTIALLY CONTRADICTED** (changed from run 2's UNVERIFIABLE — see RERUN DELTA below). Caveat: market-definition and vintage plausibility test, not an audited market-share verification; the peer's figures are management estimates on an earnings call, not a third-party market study, and there is no independent source in corpus that measures KABRAEXTRU's or Rajoo's category shares on a common, audited basis. |
| Peer evidence | RAJOOENG supplies two usable domestic sizing figures for exactly the category KABRAEXTRU competes in (extrusion and thermoforming machinery): "if we look at the domestic situation the industries which we cater to... the industry would be in the clear region of 1500 crores putting all the extrusion and thermoforming in products together" (RAJOOENG, Q4 FY24, 18-Apr-2024, PDF p.11); and, asked directly whether Rs2,000 Cr is the India market size, Khushboo Doshi answers "No, it's a total market size with the kind of line which we cater to" (RAJOOENG, Q2 FY25, 22-Oct-2024, PDF p.6) — i.e. the Rs2,000 Cr figure is management's own caveat as NOT specifically domestic, likely a broader (global-inclusive) figure for Rajoo's own served machine lines. Taking the more clearly domestic Rs1,500 Cr figure (PDF p.11) as the anchor and the Rs2,000 Cr figure (PDF p.6) as an outer bound despite its scope ambiguity: KABRAEXTRU's own FY26 extrusion segment revenue of Rs314.89 Cr (AR FY26, Note 38) implies a domestic market share of Rs314.89/Rs2,000 = 15.7% (≈16%) at the low end to Rs314.89/Rs1,500 = 21.0% at the high end — i.e. roughly 16-21%, against the ~40% claimed. Separately, Rajoo states category-specific shares for its OWN products: 80% of the domestic horizontal sheet extrusion and thermoforming market and ~60% of the domestic blown-film market (RAJOOENG, Q4 FY24, 18-Apr-2024, PDF p.7); 33% of India's PVC/CPVC extrusion market by installed capacity, and 55-60% of the domestic blown-film market (RAJOOENG, Q2 FY25, 22-Oct-2024, PDF p.11 and p.12 respectively). These are Rajoo's shares in Rajoo's categories, not a direct read on KABRAEXTRU; they are supplied as corroborating context that the domestic extrusion-machinery market is genuinely segmented enough that one player holding 80% of one sub-category and another holding ~20% of the whole is not internally inconsistent, which is one reason the verdict is PARTIALLY, not fully, CONTRADICTED. |
| Peers silent | RAJOOENG never names or describes KABRAEXTRU in its market-share answers. HBLENGINE, WINDMACHIN not applicable/no transcript. |
| Net read | The arithmetic check is the first quantified test this claim has received anywhere in the pipeline. Using KABRAEXTRU's own FY26 extrusion revenue against the peer's own domestic market sizing puts KABRAEXTRU at roughly 16-21% of the domestic extrusion-machinery market, not ~40%, a gap too large to explain by rounding or category-definition slack alone. Two things cut the other way and keep this at PARTIALLY rather than fully CONTRADICTED: (1) Rajoo's sizing is an unaudited, single-management estimate, not an independent market study, and the exact product scope it covers (does it include KABRAEXTRU's non-extrusion-machinery lines, or exclude segments where KABRAEXTRU is stronger?) is not verifiable from either side's disclosure; (2) the ~40% claim was made in AR FY25 off FY25 revenue (higher, pre-decline, since FY26 revenue is down 13.2%), and Rajoo's sizing dates from Apr/Oct-2024 — using FY25 extrusion revenue (~Rs362.78 Cr, backed out from the 13.2% FY26 decline) against the same Rs1,500-2,000 Cr range gives ~18-24%, still far below ~40% but not materially different in conclusion; if the domestic market itself grew between 2024 and the FY26/FY25 comparison years, the implied share would be even lower, which would sharpen, not soften, the contradiction. On the only tangential peer-mention context: asked directly who its "main peers in our segment" are, RAJOOENG's MD named only two domestic players — "Windsor machines and carbon extrusion" (RAJOOENG, Q4 FY24, 18-Apr-2024, PDF p.9, corrected from run 2's p.8). "Carbon extrusion" does not correspond to any known Indian extrusion-machinery maker; it is very likely a mistranscription of "Kabra Extrusion." Treated cautiously as an inference, not a confirmed quote, this is weak circumstantial evidence that a direct peer regards KABRAEXTRU as one of only two domestic competitors worth naming, consistent with some leadership position, but says nothing about magnitude and does not resolve why the ~40% figure vanished in AR FY26. See Part 2D. |

### Claim 4 — Raw-material cost trend and pass-through

| Field | Content |
|---|---|
| Claim | KABRAEXTRU's AR MD&A never discusses raw-material cost trends despite gross margin falling 326 bps FY25→FY26. |
| Verdict | **UNVERIFIABLE** for the FY25-26 window itself (peer data stops 18 months earlier); peer signal noted for synthesis. Unchanged from run 2. |
| Peer evidence | RAJOOENG, Q2 FY24, 6-Nov-2023, PDF p.7: "the raw material prices have gone up... only volume can help us to rationalize it," managed via back-to-back, order-linked procurement (RAJOOENG, Q2 FY24, 6-Nov-2023, PDF p.10 — corrected from run 2's p.9; the offset is fixed here per the rerun instruction). RAJOOENG, Q4 FY24, 18-Apr-2024, PDF p.14 (corrected; run 2 cited p.12): "the prices of raw material is more or less remain stable and there were no major fluctuations," with the only cost pressure coming from Red Sea logistics lead times, not commodity price. RAJOOENG, Q2 FY25, 22-Oct-2024, PDF p.13: "raw material prices have remained more or less in the range of previous" (mix-driven changes only: "last year there was an apple and now it's the apple-plus-plus"). Margins expanded steadily across all four calls: EBITDA margin 8.76% (FY23) → 13.52% (FY24) → 15.10% (H1 FY25); PAT margin 6.16% → 10.65% → 11.68% (RAJOOENG, Q4 FY23 PDF p.3; Q4 FY24 PDF p.5; Q2 FY25 PDF p.4). WINDMACHIN's screener data contains no raw-material or gross-margin-driver commentary of any kind; it is inapplicable to this claim. |
| Peers silent | HBLENGINE, WINDMACHIN not applicable/no transcript-equivalent commentary. |
| Net read | The closest peer reports raw material as broadly stable through Oct-2024, with margin expansion driven by capacity utilisation and export mix, not commodity relief. If KABRAEXTRU's 326 bps FY25-26 gross margin compression were purely an industry-wide raw-material shock, the nearest comparable data point argues against that, pointing toward a company-specific (mix, pricing, or execution) explanation as more likely, but the 18-month data gap keeps this a lean, not a proof. |

### Claim 5 — Export weakness, geopolitical/currency factors
...
| Field | Content |
|---|---|
| Claim | KABRAEXTRU carries a stale, unrefreshed Rs30.39 Cr Hero Electric (HEVPL) receivable; HEVPL is now under NCLT insolvency. What EV-OEM credit exposure does HBL Engineering disclose in its own battery vertical? |
| Verdict | **UNVERIFIABLE** — segment mismatch. Unchanged verdict from run 2; net read enriched per rerun instruction. |
| Peer evidence | None on OEM credit exposure specifically. HBL Engineering's lithium-ion activity is explicitly confined to Navy defence cells, a deliberate strategic choice to avoid the general/EV lithium-ion market: "I knew six years ago that no one outside China can make a profit from the production of lithium ion cells... We chose a niche for defense" (HBLENGINE AGM, 25-Sep-2025, PDF p.3-4). Its electric-vehicle exposure is limited to 35-55 tonne electric trucks, explicitly not two/three-wheelers — the company dropped its smaller-truck prototypes to focus on heavy vehicles (HBLENGINE AGM, 25-Sep-2025, PDF p.15-16). No two/three-wheeler OEM, and no OEM name (Hero Electric or otherwise), is mentioned anywhere in the transcript. New this rerun: a direct capital-scale contrast. HBL states "by the time this fiscal year ends, we would have invested perhaps 200 crores or less. And we will make a profit from year one" (HBLENGINE AGM, 25-Sep-2025, PDF p.4). Geon is stated elsewhere in the corpus to have had roughly Rs250 Cr invested (AR FY26 p.36, Note 38 p.105-106) against a Rs43.35 Cr FY26 segment loss that widened 69.8% YoY. The two investments are of the same rough order of magnitude (~Rs200-250 Cr); the outcomes are opposite. This draws the contrast the fix list asks for without requiring a segment match: it is not evidence that Geon's specific loss is avoidable at the same capital scale (HBL's defence-niche economics, customer base, and pricing power are categorically different from EV-OEM pack assembly), but it does show that capital scale alone does not explain profitability outcomes in Indian lithium-ion investing — strategic segment choice (defence-niche premium vs. commoditised EV OEM) appears to matter more, which is consistent with HBL's own explicit thesis (see Claim 8 and Part 2E). |
| Peers silent | HBLENGINE does not operate in the two/three-wheeler EV space at all. WINDMACHIN not applicable (different industry, no transcript). RAJOOENG not asked (different industry). |
| Net read | This remains a genuine segment mismatch, not a gap in questioning. The new capital-scale contrast (~Rs200 Cr HBL vs ~Rs250 Cr Geon, profit from year one vs a widening loss) is informative context for the broader question of whether Geon's economics are structurally hard or a matter of segment choice, but it still says nothing directly about EV-OEM customer credit quality, which is what this specific question asked. The claim stays UNVERIFIABLE for its stated question; the contrast belongs more properly to the broader Claim 8 discussion, and is repeated there. |

### Claim 8 — HBL Engineering: capacity utilisation and margin in its own lithium-ion battery pack business

| Field | Content |
|---|---|
| Claim | Tests whether Geon's negative operating leverage (segment loss +69.8% on revenue +7.2%) is industry-wide or company-specific execution. |
| Verdict | **UNVERIFIABLE** — segment mismatch; no comparable disclosure exists. Unchanged verdict from run 2; net read enriched per rerun instruction and corrected quote (see RERUN DELTA). |
| Peer evidence | HBL does not disclose capacity utilisation or margin for a lithium-ion battery-PACK assembly business comparable to Geon; its lithium-ion activity is cell-level, Navy-only, and profitable "from year one" on "perhaps 200 crores or less" of cumulative investment (HBLENGINE AGM, 25-Sep-2025, PDF p.4), by design, because it avoided the commoditised, low-margin end of the lithium-ion market. Separately, on its mature nickel-cadmium battery business, HBL notes commoditised lithium segments carry no margin: "when everybody jumps on lithium and everybody can import sales, there is no margin in it. So we are not participating" (HBLENGINE AGM, 25-Sep-2025, PDF p.17). This corrects a transcription-sensitive misquote in run 2, which rendered the same sentence as "everybody can import cells." The transcript's actual word is "sales," not "cells"; the probable intended meaning (imported finished lithium cells/products flooding a price-competed segment) is the same either way, but the verbatim word must be quoted as printed. Capital-scale contrast (see also Claim 7): ~Rs200 Cr HBL cumulative lithium-ion investment, profitable from year one, vs. ~Rs250 Cr Geon cumulative investment (AR FY26 p.36, Note 38 p.105-106) against a Rs43.35 Cr FY26 segment loss, widened 69.8% YoY on 7.2% revenue growth. |
| Peers silent | No peer discloses a comparable lithium-ion EV battery-pack margin/utilisation trend. RAJOOENG not applicable (different industry). |
| Net read | The claim cannot be tested directly; HBL's Navy-cell economics and Geon's EV-OEM-pack economics are not the same business. The structural comment about commoditised lithium-ion economics ("everybody can import sales, there is no margin in it") is informative context, not a substitute answer: it describes cell-level economics in a market HBL avoided, not pack-assembly economics in the EV OEM market Geon actually serves. The capital-scale contrast (near-identical investment size, opposite outcome) sharpens the question this claim asks without answering it: it is consistent with a reading that Geon's negative operating leverage reflects the segment it chose to compete in (commoditised, OEM-price-taking EV packs) more than an unavoidable feature of lithium-ion investing generally, but this is an inference from a structurally different peer, not a tested finding, and should be labelled as such in synthesis. |

### Claim 9 — HBL Engineering: India EV battery pack market-size figure

| Field | Content |
|---|---|
| Claim | KABRAEXTRU's own two ARs cite India EV battery pack market sizes roughly 100x apart (USD 2.22 bn→13.89 bn per AR FY25; USD 39.39 mn→254.59 mn per AR FY26). Does HBL cite any comparable figure? |
| Verdict | **UNVERIFIABLE** — no figure cited. Unchanged from run 2. |
| Peer evidence | None. HBL Engineering cites no India EV battery pack market-size figure anywhere in the AGM transcript. Its market commentary is confined to its own served niches: Kavach railway signalling ("budgeting for 3000 crores in sales of this fiscal year," HBLENGINE AGM, 25-Sep-2025, PDF p.2), defence fuses, and a long-term "Rs4,500 crore by FY30" company revenue target (PDF p.3). |
| Peers silent | RAJOOENG, WINDMACHIN not applicable/no transcript. |
| Net read | No peer figure exists to triangulate against either of KABRAEXTRU's own internally-inconsistent numbers. The ~100x discrepancy between KABRAEXTRU's own two ARs remains unresolved by anything in this peer set. |

### Claim 10 — NEW (operator fix-list item 5): Working-capital terms, Rajoo vs KABRAEXTRU's receivable profile
...
## SUMMARY TABLE (all ten claims, verdict with caveat inline)

| # | Claim (short) | Verdict (caveat inline, not only footnoted) |
|---|---|---|
| 1 | JJM/state-infra external-blame framing, 13.2% extrusion decline | CONTRADICTED — framing plausibility only, peer data through Oct-2024; not a test of FY26 figures |
| 2 | Extrusion machinery global CAGR (3.9% vs 6.7%) | PARTIALLY VERIFIED — direction only, lower figure favoured |
| 3 | ~40% extrusion market share, dropped from AR FY26 | PARTIALLY CONTRADICTED — peer sizing implies ~16-21%; market-definition and vintage caveat, not an audited share verification |
| 4 | Raw-material trend / pass-through vs 326 bps margin fall | UNVERIFIABLE — peer data through Oct-2024, does not reach FY25-26 window |
| 5 | Export weakness framed as geopolitical/currency | CONTRADICTED — framing plausibility only, peer data through Oct-2024; not a test of FY26 figures |
| 6 | Capex halved amid reiterated growth trajectory | CONTRADICTED (direction) — framing plausibility only; RAJOOENG data through Oct-2024, WINDMACHIN screener data unexplained and possibly inorganic |
...
**2A. Demand environment.** RAJOOENG's demand narrative across all four calls is one of
acceleration, not weakness: revenue growth of -7% (FY23, currency-driven export delay), then
+23.5% (FY24), then +27.1% (H1 FY25); order book climbing from Rs140 Cr to Rs200+ Cr; a cited
Rs1,000 Cr enquiry pipeline by Oct-2024 (RAJOOENG, Q2 FY25, 22-Oct-2024, PDF p.13/15). This is a
clear divergence from KABRAEXTRU's FY26 extrusion segment framing, subject to the 18-month
...
Oct-2024, protected by order-linked back-to-back procurement, with margin expansion (EBITDA
margin 8.76%→15.10%, PAT margin 6.16%→11.68% across the four calls) driven mainly by capacity
utilisation and a shift toward higher-margin exports ("domestic is not really encouraging margin,
the margin comes from the export business," RAJOOENG, Q2 FY25, 22-Oct-2024, PDF p.12; net margin
~4-5% domestic vs "nearly 30% to 35% more" on exports, RAJOOENG, Q4 FY23, 16-May-2023, PDF p.20).
This does not match a narrative of margin compression from raw-material inflation for the peer
group as of late 2024. WINDMACHIN's screener data carries no pricing or input-cost commentary and
...
MD Khushboo Doshi named two domestic players, "Windsor machines and carbon extrusion" (RAJOOENG,
Q4 FY24, 18-Apr-2024, PDF p.9 — corrected from run 2's p.8). "Carbon extrusion" is not a known
Indian extrusion-machinery company; it reads as a plausible mistranscription of "Kabra Extrusion."
Flagged with appropriate caution (this is an inference, not a confirmed quote) as the only
candidate competitive mention of the main company found in this peer set. If correct, it is weak,
incidental corroboration that a direct peer independently regards KABRAEXTRU as one of only two
domestic competitors worth naming unprompted — consistent with, but not proof of, some form of
market leadership; it says nothing about magnitude and does not explain the AR FY26 disappearance
of the ~40% figure (see Claim 3, now PARTIALLY CONTRADICTED on separate quantitative grounds).
Note also that the SAME answer names Windsor Machines as the other domestic peer, independently
corroborating that WINDMACHIN's inclusion in the manifest, and its use in this rerun via screener
...
finding (AR FY26 Note 9 p.88) with no stated policy context at all.
...
- **Claims contradicted:** 3 of 10 (Claim 1, external-blame framing; Claim 5, export weakness;
  Claim 6, capex cycle) — all three carry the same staleness caveat, stated inline in the summary
  table above, not only here: contradicted as of the closest observable peer window (through
  Oct-2024, plus one unexplained FY26 screener signal for Claim 6), not directly tested against
  the FY26 figures themselves. These go to synthesis as priority items, framed with that caveat
  attached, not as flat contradictions of FY26 numbers.
- **Claims unverifiable:** 4 of 10 (Claim 4, RM trend; Claims 7-9, all HBL/EV-battery questions —
  genuine segment mismatch, not a gap in the questions asked, though Claims 7-8 now carry an
  explicit capital-scale contrast as context).

**Single most consequential contradiction.** Taken together, Claims 1, 5, and 6 describe the same
peer (RAJOOENG) accelerating revenue, accelerating exports, and actively adding capacity through
the last observable quarter (Oct-2024) — the opposite of an extrusion machinery peer bracing for
or already inside a JJM/infra-driven, export-weak, capex-cautious downturn. Claim 3's arithmetic
(implied ~16-21% domestic share against a claimed ~40%) adds a second, independently-derived
challenge that does not depend on the 18-month staleness gap at all, since it tests a claim made
contemporaneously with the peer's own market-sizing statements. This does not disprove
KABRAEXTRU's FY26 account, but it removes the comfort of an unexamined "this is just what the
...
**Hypothesis (carried from run 2, re-tested against the two new findings; unchanged, now with
one added qualifier):** across this small peer set, margin trajectory in Indian extrusion/battery
capital-goods small-caps tracks EXPORT/PREMIUM-NICHE ORIENTATION far more tightly than it tracks
...
point to the same underlying mechanism: in this class of Indian small-cap capital-goods/battery
names, margin resilience now depends on how much of the business sits in an export or technical
niche insulated from domestic, price-led competition, rather than on the strength of the domestic
capex cycle in general. Tested against KABRAEXTRU: its FY26 extrusion export revenue FELL 11.6%,
moving against this cross-peer pattern at exactly the point in the cycle when the pattern (per
RAJOOENG) rewards export mix most; and Geon's investment sits in the commoditised, OEM-price-taking
end of the lithium-ion spectrum that HBL's chairman explicitly describes avoiding, at a similar
capital scale to HBL's profitable niche investment (see Claims 7-8). WINDMACHIN's screener data
cannot be folded into this hypothesis (no export/domestic or margin-driver breakdown exists in the
CSV), so the hypothesis rests on RAJOOENG and HBLENGINE only, as in run 2. If the pattern holds,
KABRAEXTRU's FY26 problem is at least partly a mix problem, losing the export lever that is
protecting margin elsewhere in the peer set, and Geon's problem is at least partly a segment-choice
problem, sitting in the commoditised end HBL's own chairman names as structurally margin-free,
rather than, or in addition to, a purely macro/JJM-driven or industry-inherent one. This is
testable: it predicts that KABRAEXTRU's segment margin should correlate positively with its own
export share in future periods, and that any FY27+ recovery attributed to "JJM 2.0" without an
accompanying export-share recovery should be treated with added skepticism.
...
receivable-days (H1 FY24) quotes, re-anchored to PDF p.10, p.12, and p.11 respectively (RAJOOENG,
Q2 FY24, 6-Nov-2023), tested against KABRAEXTRU's 48.9% gross-receivables-over-one-year-overdue
figure (AR FY26 Note 9 p.88).
- BEFORE: not present in run 2 (B05 peer_questions had 9 items; this was operator fix-list item 5
...
market-size figure with its own scope caveat (Q2 FY25, 22-Oct-2024, PDF p.6), against KABRAEXTRU's
Rs314.89 Cr FY26 extrusion segment revenue (AR FY26 Note 38), giving an implied domestic share of
~16-21%.
- BEFORE: Claim 3 verdict UNVERIFIABLE ("No peer statement addresses KABRAEXTRU's market share,
  positively or negatively").
- AFTER: Claim 3 verdict PARTIALLY CONTRADICTED, with the arithmetic shown in full and the
  market-definition/vintage caveat stated explicitly (not fully CONTRADICTED, because the peer
  sizing is an unaudited management estimate of ambiguous exact scope, and the ~40% claim's own
  vintage (FY25) predates the FY26 revenue figure used in the arithmetic, though using FY25
  revenue instead does not materially change the conclusion — see Claim 3's own net read).

**Item 12 (WINDMACHIN screener use).** Added `WINDMACHIN-Data_Sheet.csv` as a used, caveated
source against Claims 1, 5, and 6: FY26 sales +72.9% to Rs566.52 Cr from Rs327.6 Cr (row 11);
net profit negative in both FY25 (-Rs25.27 Cr) and FY26 (-Rs4.43 Cr) though narrowing (row 24); a
FY25 equity-capital rise (Rs12.99 Cr→Rs16.90 Cr) and Investments spike (Rs9.19 Cr→Rs343.11 Cr)
against a flat-to-falling Net Block (rows 39, 46, 44), suggesting a possibly inorganic event, not
confirmed by any note in the screener; and the June-2026 quarter (row 28: Rs146.21 Cr sales,
row 35: -Rs1.08 Cr net profit).
- BEFORE: WINDMACHIN listed UNUSED in the Part 3 coverage map, with the gap named but the
...
1. Claim 4 back-to-back procurement quote: RAJOOENG Q2 FY24, PDF p.10 (was p.9 in run 2).
2. Claim 3 / Part 2D "Windsor machines and carbon extrusion" quote: RAJOOENG Q4 FY24, PDF p.9
   (was p.8 in run 2).
3. Claim 5 45% FY24 export share (Sriram R exchange): RAJOOENG Q4 FY24, PDF p.12 (was p.11 in
   run 2).
4. Claim 3 33% PVC market-share quote: RAJOOENG Q2 FY25, PDF p.11 (was cited as p.9-10 in run 2).
5. Claim 3 55-60% blown-film market-share quote: RAJOOENG Q2 FY25, PDF p.12 (was cited as p.9-10
   in run 2).
6. Claim 1 "domestic is not really encouraging margin" / 73% export quote: RAJOOENG Q2 FY25, PDF
   p.12 (was p.11 in run 2).
7. HBLENGINE AGM p.17 quote: the transcript prints "everybody can import sales," not "everybody
   can import cells." Quoted verbatim in Claim 8 and Part 5 above; the probable transcription
   meaning (imported finished lithium cells or products) is noted separately from the verbatim
   quote, per instruction.

Two further offsets were found and corrected during this rerun's independent page-by-page
re-read, beyond the seven named: the RAJOOENG Q4 FY24 Rs9.33 Cr FY24 capex figure is on PDF p.6,
not p.5 as cited in run 2 (Claim 6); and the Rajoo Bausano JV Rs30 Cr FY23 turnover figure is on
PDF p.16 of the Q4 FY23 (16-May-2023) call, not p.17 as cited in run 2 (Claim 1). Both are
corrected inline above, consistent with the instruction to re-verify every anchor against the
marker, not only the seven named.

**Claims 7-8, HBL investment-scale contrast (from the gate-recommendation's own audit note, not
numbered separately in the fix list but assigned to this rerun).** Added the explicit,
side-by-side statement that HBL's own "perhaps 200 crores or less" cumulative lithium-ion
investment, expected to be "profit from year one" (HBLENGINE AGM, 25-Sep-2025, PDF p.4), sits at
the same rough order of magnitude as Geon's ~Rs250 Cr invested (AR FY26 p.36, Note 38 p.105-106)
against a Rs43.35 Cr FY26 segment loss.
- BEFORE: run 2 treated HBL purely as a segment mismatch supplying no confirmation or
  contradiction on Claims 7-8, with no capital-scale comparison drawn.
- AFTER: verdicts on Claims 7 and 8 remain UNVERIFIABLE (the segment mismatch is real and the
  contrast does not resolve either question), but both "Peer evidence" and "Net read" fields now
  state the ~Rs200 Cr vs ~Rs250 Cr, profit-from-year-one vs widening-loss contrast explicitly,
  still labelled a weak-fit peer comparison, per instruction.

**Caveat placement (gate-recommendation instruction, applies across all items above).** The
"framing plausibility, not FY26 figures" caveat (or, for Claim 3, the analogous "market-definition
and vintage plausibility, not an audited share verification" caveat) is now stated inline in the
Verdict field of every affected Part 1 table row AND in the dedicated Summary Table above, not
only in the staleness-notice paragraph at the top of the report as in run 2.

---

## SOURCES RE-READ IN FULL FOR THIS RERUN
...
input_gaps:
  ...
  - "peer-concall-windsor: transcript absent; screening CSV (WINDMACHIN-Data_Sheet.csv) used this rerun against Claims 1 and 6, with explicit caveats, per fix-list item 12; still no earnings-call-quality disclosure for Windsor"
  - "peer-concall-mislabel-stale: RAJOOENG-Concall_Nov_2025_Transcript.txt is mislabeled by the collector; verified from p.1 as the Q2 FY25 call held 22-Oct-2024. All four RAJOOENG transcripts stop 18 months before KABRAEXTRU's FY26 close (31-Mar-2026); HBLENGINE is a 25-Sep-2025 AGM, not an earnings call, and is a segment mismatch for Geon (Navy-only lithium-ion vs EV battery packs)"
  - "screener-csv-defect: carried forward per orchestrator; no defect observed in WINDMACHIN rows used this rerun"
  - "sector_cap_row: carried forward per orchestrator, not applicable to this stage"
flags:
  - {type: "FLAG-PEER-DATA-STALE-VS-FY26-CLAIM-WINDOW", reason: "Newest RAJOOENG earnings call is 22-Oct-2024, ~17-18 months before KABRAEXTRU's FY26 close; every CONTRADICTED verdict on Claims 1, 5, 6 tests framing plausibility only, not FY26 figures"}
  - {type: "FLAG-WINDSOR-TRANSCRIPT-MISSING-SCREENER-ONLY-USED", reason: "No WINDMACHIN transcript in corpus; RAJOOENG's own MD named Windsor as one of only two domestic competitors tracked (Q4 FY24, 18-Apr-2024, PDF p.9); this rerun uses WINDMACHIN-Data_Sheet.csv against Claims 1 and 6 with explicit caveats, but no filed or management-commentary disclosure exists for Windsor in this corpus"}
  - {type: "FLAG-HBL-SEGMENT-MISMATCH-GEON-UNVERIFIABLE", reason: "HBLENGINE's lithium-ion activity is Navy-defence-cell only, not EV battery packs; Claims 7-9 remain UNVERIFIABLE despite the new capital-scale contrast added this rerun"}
...
unverifiable:
  ...
  - {claim: "HBL Engineering capacity utilisation / margin trend in own lithium-ion battery pack business", peers_checked: ["HBLENGINE"]}
  - {claim: "India EV battery pack market-size figure (KABRAEXTRU's own two ARs cite figures ~100x apart)", peers_checked: ["HBLENGINE"]}
peer_coverage_map:
