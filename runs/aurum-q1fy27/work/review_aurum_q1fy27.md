# Q1 FY27 MERGED QUARTERLY REVIEW — Aurum PropTech Limited (AURUM / BSE 539289)

Agent: A4 ANALYST (Opus 4.8) | Run: aurum-q1fy27 | Review date: 2026-07-21
Doctype in scope: INVESTOR PRESENTATION (Reg. 30), 34 slides.
Companion anchor: Q1 FY27 Reg-33 FILING, reviewed 2026-07-20 (Role 4, filing-only) — the authoritative numerical baseline. Where the presentation's framing conflicts with the filing, the filing wins and the contradiction is logged.

---

## LEDGER-RECONCILIATION PREAMBLE (contractual, before Step 1)

Ledger contains 0 notes / 0 turns / 34 slides. All 34 reviewed.
...
**Business type:** Standard operating business (PropTech platform group). Integrow (digital-lending / Capital arm) is equity-accounted as an associate, not consolidated as a lender, so the lender variants (Steps 1L, 5L, 2L) are N.A.; the standard template governs.

**Decision Status verified (live Notion, fetched 2026-07-21 by orchestrator):** AVOID at CMP Rs.240. Entry zone Rs.71–89, MoS Rs.71. Position: None. This is a NON-HELD name → Step 8 uses branch **8A-W**. No HOLD/ADD/TRIM/EXIT framing applies.

---

# SECTION A — RESULTS REVIEW (Role 4, adapted to presentation companion)

## STEP 0 — PRE-FLIGHT

- **0A Notion:** fetched live (inline). Thesis: transition alpha resting on Distribution scaling profitably; AVOID; Promoter Verdict CONCERN; FTTCP +3/8 DEEP WATCH (Revenue FIRING, Margin STARTING, Cash STAGNANT/INDETERMINATE, ROCE STAGNANT). Falsification metric already FIRED in the filing.
- **0B Units:** Deck primary unit = ₹ Crores (slide-26 build-up explicitly "figures in ₹ Cr."). Scattered Lakhs figures tagged inline (segment loss "(₹5) Lakhs" = −Rs.0.05 Cr; per-team-member figures). Conversion: Lakhs ×0.01, Millions ×0.1 (Millions are counts/USD, not ₹). No conversion errors introduced.
- **0C Share-count changes:** Deck discloses ONE dilution vector — 1,97,93,309 new equity shares to REA India for Housing.com (→ REA ~24.9%), slide 9, l.298-300. It OMITS the second vector the same 16-Jul-2026 board approved — 51-lakh Fully Convertible Warrants to promoter entity AREDL (verified absent: grep of the full extract returns zero hits for "warrant/AREDL"; the only "impairment" hit, l.812, is generic Ind AS 116 boilerplate). EPS-dilution quantification for BOTH legs = ND in deck → QfM.
- **0D Numbered notes:** ND-by-doctype (a presentation has no numbered notes). The one substantive note is the Ind AS 116 RoU boilerplate (l.811-813). All one-off / accounting-change disclosure lives in the companion filing.
- **Auditor opinion:** ND-by-doctype. Companion filing / Notion flags: MSKA statutory-auditor consent withdrawal; internal-audit change; Kirtane & Pandit / Varma & Varma per the standing PROMOTER-CONCERN flag. All absent from the deck (verified) → A3-14, QfM.

🛑 Pre-flight complete: Notion fetched (Decision Status AVOID verified), units identified, both dilution vectors noted, notes ND-by-doctype, auditor ND-by-doctype, business type Standard.

## STEP 1 — DATA EXTRACTION

The deck carries only the slide-26 "P&L — Reconciliation of Adjusted EBITDA" (a bespoke build-up, NOT a Reg-33 P&L). It is reproduced in full and every cell anchored. Standard Reg-33 rows the deck does not carry are ND-by-doctype and anchored to the companion filing in Table 1B.

### Table 1A — Deck P&L build-up, slide 26 (17/17 rows, ₹ Cr., Q1 FY26 → Q1 FY27)

| Line item | Q1 FY26 | Q1 FY27 | Anchor |
|---|---|---|---|
| PBT / Total Income (%) | −14.0% | 1.9% | l.785 |
| EBITDA / Total Income (%) | 28.4% | 31.9% | l.786 |
| Adjusted EBITDA / Adjusted Income (%) | −3.0% | 10.2% | l.787 |
| Adjusted Income (TIr) | 73.26 | 117.80 | l.792 |
| Add: Other income related to RoU assets | 3.71 | 2.99 | l.793 |
| Total Income (TI) | 76.96 | 120.79 | l.795 |
| Less: Employee benefits & Other expenses | 55.09 | 82.22 | l.796 |
| EBITDA | 21.87 | 38.56 | l.797 |
| Add: ESOP Costs | 1.22 | 0.81 | l.800 |
| Less: Other income related to RoU assets | 3.71 | 2.99 | l.801 |
| Less: Long-term lease payments | 21.61 | 24.31 | l.803 |
| Adjusted EBITDA (before ESOP & RoU) (EBITDAr) | −2.23 | 12.07 | l.804 |
| Less: ESOP Costs | 1.22 | 0.81 | l.805 |
| Less: Finance costs | 1.66 | 1.06 | l.806 |
| Less: Depreciation costs | 5.67 | 6.39 | l.807 |
| Less: Impact of IND AS | ND (nil in Q1FY26) | 1.47 | l.808 |
| PBT (before Exceptional Items) | −10.78 | 2.35 | l.809 |

Arithmetic check (all ties): EBITDA 38.56 / TI 120.79 = 31.9% ✓; PBT 2.35 / TI 120.79 = 1.9% ✓; EBITDAr 12.07 / Adj Income 117.80 = 10.2% ✓. Build-up ties: 38.56 +0.81 −2.99 −24.31 = 12.07 ✓; 12.07 −0.81 −1.06 −6.39 −1.47 = 2.34 ≈ 2.35 (rounding) ✓.

### Table 1B — Standard Reg-33 rows (deck-silent → companion filing anchor)

| Line item | Q1 FY26 | Q1 FY27 | Source |
|---|---|---|---|
| Revenue from Operations (continuing) | ND (deck); ~65.4 implied¹ | 111.84 | Filing, reviewed 2026-07-20 |
| Total Income (deck TI) | 76.96 | 120.79 | Deck l.795 |
| Operating PBT ex-Other Income (continuing) | ND | −4.86 | Filing |
| PBT after associate share (continuing) | ND | +1.30 | Filing |
| Associate (Integrow) share | ND | −1.01 | Filing |
| Tax expense (continuing) | ND | ND (not itemised in inputs) | Filing |
| PAT — continuing operations | ND | −0.34 | Filing |
| PAT — discontinued operations | ND | +45.52 | Filing (incl. Rs.52.35 Cr Navi Mumbai building-sale gain) |
| **Reported total PAT** | ND | **45.18** | Filing |
| EPS (reported / share-adjusted) | ND | ND | Not in deck or inputs |

¹ 111.84 ÷ 1.71 (filing states +71% YoY on full-quarter PropTiger consolidation; Q1 FY26 had zero PropTiger). Shown as an implied reference only, NOT used in any anchored analysis.

**Cell-by-cell discipline:** every deck row is a line-anchored number; every deck-silent row is ND or filing-anchored. No estimation entered any anchored table.
...
|---|---|---|---|---|
| Total Income (deck) | 76.96 (l.795) | 120.79 (l.795) | +56.9% (deck "57%", l.108) | Grows — but inorganic (PropTiger full-quarter consol) |
| Adjusted Income (deck) | 73.26 (l.792) | 117.80 (l.792) | +60.8% | Grows, same driver |
| Revenue from Ops (continuing, filing) | ND | 111.84 | +71% | Grows, PropTiger-driven |
| EBITDA (reported, incl. RoU OI) | 21.87 (l.797) | 38.56 (l.797) | +76.3% | Expands on reported basis |
| Adjusted EBITDA / EBITDAr | −2.23 (l.804) | 12.07 (l.804) | swing +14.30; margin −3.0%→10.2%, +1320 bps (l.116) | Swings positive — but on a lease-add-back basis (see A3-12) |
| Finance costs | 1.66 (l.806) | 1.06 (l.806) | −36.1% | Lower |
| Depreciation | 5.67 (l.807) | 6.39 (l.807) | +12.7% | Higher |
| PBT before exceptionals (deck) | −10.78 (l.809) | 2.35 (l.809); margin −14.0%→1.9%, +1590 bps (l.123) | swing +13.13 | Positive on deck basis ONLY |
| **Core operating PBT ex-OI (continuing, filing)** | ND | **−4.86** | n/a | **NEGATIVE — falsification metric FIRED** |
| PAT — continuing operations (filing) | ND | −0.34 | n/a | LOSS |
...
|---|---|---|---|---|---|
| Q1 FY26 | 76.96 (deck TI, l.795) | −3.0% Adj (l.787) | ND | none disclosed in deck | base |
| Q1 FY27 | 120.79 (deck TI, l.795) | 10.2% Adj (l.787) | −4.86 (filing) | Rs.52.35 Cr building-sale gain; Rs.1.47 Cr "Impact of IND AS" | ND — deck gives NO sequential column |

QoQ is **ND-by-doctype**: the deck presents only Q1 FY27 vs Q1 FY26 (YoY), no Q4 FY26 / Q2 / Q3 sequential column. Trajectory across the last 4–6 quarters cannot be built from this artifact; it lives in the filing/Notion history. Flag: DATA_GAP (no sequential run-rate in deck).

🛑 QoQ ND, basis stated.

## STEP 4 — OPERATIONAL DECOMPOSITION (PAT bridge)

Bridge from deck's positive "PBT before exceptionals" to the filing's reported PAT — i.e., the lines the deck removed:

| Component | ₹ Cr | Recurring? | Anchor |
|---|---|---|---|
| Deck PBT (before Exceptional Items), Q1 FY27 | +2.35 | mixed (see below) | Deck l.809 |
| Less: Integrow associate share (deck build-up excludes it) | −1.01 | Recurring (associate) | Filing |
| = PBT after associate (continuing) | +1.30 | — | Filing |
| Less: Tax (continuing) | −1.64 (balancing to −0.34)² | Mixed | Filing (derived) |
| = PAT — continuing operations | −0.34 | Recurring | Filing |
| Add: PAT — discontinued operations | +45.52 | NON-RECURRING | Filing |
| — of which Navi Mumbai building-sale gain | +52.35 | NON-RECURRING (program complete) | Filing |
| **= Reported total PAT** | **+45.18** | — | Filing |
| Memo: RoU "other income" credited inside deck EBITDA | +2.99 | NON-RECURRING character | Deck l.793 |
| Memo: unexplained "Impact of IND AS" charge (new) | −1.47 | UNKNOWN — QfM | Deck l.808 |

² Tax is a balancing figure between filing PBT-after-associate +1.30 and continuing PAT −0.34; not itemised in the supplied inputs → shown as derived, marked so.

**Answers:**
- **% of PAT from recurring core vs non-recurring:** ~0% recurring. Continuing operations are a −0.34 Cr loss; 100%+ of the +45.18 reported PAT is the non-recurring Rs.52.35 Cr building-sale gain. The building-sale program is now **complete** — this gain does not repeat.
- **If the one-time gain reverts:** run-rate PAT is a small continuing loss. There is no treasury/other-income buffer to replace a Rs.52 Cr asset-sale gain next quarter.
- **D&A / finance at steady state?** D&A +12.7% YoY, finance −36.1% YoY; not the swing factor. The swing factor is entirely the discontinued-ops gain.
- **Tax adjustments?** Continuing tax turns a +1.30 pre-tax into a −0.34 post-tax loss; the deck drops the tax line entirely (A3-11).

🛑 Bridge complete. **The deck presents a positive pre-tax, pre-exceptional, pre-associate figure to narrate profit; the audited continuing result is a loss, and reported profit is a one-time asset sale.**

## STEP 5 — CASH QUALITY & BALANCE SHEET

| Metric | Prior | Current | Change | Verdict |
|---|---|---|---|---|
| CFO | ND | ND | ND | ND — Q1, and deck carries no cash-flow statement |
| CFO/PAT | ND | ND | ND | ND |
| Capex / PPE / CWIP | ND | ND | ND | ND-by-doctype |
| Working capital / receivable days | ND | ND | ND | ND-by-doctype |
| Over-1-year receivables | ND (deck) | ND (deck) | ND | Filing/Notion flag: +327% YoY (item 4) — ABSENT from deck (A3-14) |
| Net debt | ND | ND | ND | ND-by-doctype |
| Promoter pledge | ND | ND | ND | ND-by-doctype |

**Cash conversion = INDETERMINATE** (carried from Notion: over-1-yr receivables +327% YoY, lease service ~2.5x CFO, collections unaddressed across 4 prior calls). The deck adds no cash-flow primitive and, materially, OMITS the deteriorating receivables line entirely (A3-14). Per house rule, INDETERMINATE cash conversion CANNOT silently resolve to PROCEED — it caps the disposition at PROCEED WITH CAVEATS, with the missing evidence named: **half-yearly CFO, over-1-yr receivables buckets, and lease-vs-CFO coverage, all due at the Q2 FY27 half-year filing.** This review sits below that cap (see Verdict) because of the flag load.

🛑 Cash quality ND / INDETERMINATE, missing evidence named.

## STEP 5.5 — STANDALONE vs CONSOLIDATED GAP (first-class metric, from A3 F2)

- **A3 F2 = N.A. for this doctype:** the deck presents CONSOLIDATED only; there is no standalone column to decompose, so a standalone-vs-consolidated PAT gap cannot be computed from the presentation. **sc_gap_pat_pct = ND** (deck). The genuine standalone/consolidated decomposition lives in the companion Reg-33 filing (reviewed 2026-07-20) and was not re-supplied to this run.
- **The economically meaningful gap this quarter is the continuing-vs-reported PAT gap:** continuing-ops PAT −0.34 Cr vs reported total PAT +45.18 Cr — a Rs.45.52 Cr / ~100%+ gap driven wholly by the discontinued-ops building-sale gain. This is flagged as the substitute "quality-of-earnings gap" metric in the absence of a standalone column, and is the single largest earnings-quality distortion in the quarter.
...
Probability re-weighting rule: the second-consecutive-quarter BELOW-BEAR trigger is a filing/valuation-refresh action, not a presentation action; flagged for the next Role 1 pass, not actioned here.

### 6B. Watchlist status — the 9-point monitoring checklist (deck + filing)
...
| 9 | July-2026 fund-raise | Deck shows ONLY the REA 24.9% all-equity leg (l.298-300); OMITS the AREDL 51-lakh FCW leg (A3-04/A3-07) | AMBER pending pricing |
...
**No thesis-broken trigger newly fires from the presentation.** The one operating-loss print already fired in the filing (2026-07-20); the deck does not add a second consecutive print (it presents no clean operating line). Decision Status therefore does NOT change on this artifact.

### 6D. Growth-trigger / BUY-condition status (thesis-breaks-into-BUY needs ALL three)
...
The presentation supplies **no** pillar-grade input: no ROCE, no CFO/PAT, no net worth, no clean operating margin. Per Section 1B v3.3 and the FTTCP-verdict-is-sole-authority rule, **no pillar is re-set on a marketing deck.** All pillars HOLD at their Notion values (FTTCP +3/8 DEEP WATCH: Revenue FIRING, Margin STARTING, Cash STAGNANT/INDETERMINATE, ROCE STAGNANT). Destination PE, entry zone (Rs.71–89, MoS Rs.71), and the operator forward house case (Rs.80/64 5yr, Rs.105/84 3yr) are UNCHANGED. Hurdle-ratio recheck: ND (no updated EPS CAGR or clean PE input from this artifact). Any pillar/valuation revision waits for the FTTCP + Role 1 passes on filing numbers.

🛑 Pillars HOLD; no revised fair values from this doctype.

## STEP 8 — POSITION DECISION (branch 8A-W, non-held)
...
**N.A. THIS RUN — no Q1 FY27 concall transcript exists.** Steps 1–9 of Role 5 (claims inventory, forward-guidance table, promise-vs-delivery scoring, Q&A decomposition, credibility ratio, tone/specificity, 6E archetype, cross-reference, position update) are not runnable and are marked N.A. Consequences:
- Management credibility ratio and Management Grade carry forward UNCHANGED from the prior cycle; no re-grade on a presentation.
- The commitment register mined from the deck (F6 / A3-02, A3-03, A3-07, A3-09) is NOT scored as promise-vs-delivery (that requires a transcript); it is logged in Monitorables and routed to Questions-for-Management for the pending call.
- Every open item the deck raises is routed into the Questions-for-Management table below, tagged for the pending Q1 FY27 concall.
...
| C3 | Lead metric Adjusted-EBITDA margin 10.2% / +1320 bps (l.116, l.804) | Adds back Rs.24.31 Cr long-term lease payments (real cash cost) + ESOP + RoU; bespoke, not a standard margin | PARTIALLY CONFIRMED (arithmetic ties) but MATERIALLY MISLEADING (cash rent excluded) | A3-12 |
| C4 | Rental "₹2 Cr segment profit" (l.143) | Filing Rental EBIT +Rs.0.63 Cr | CONTRADICTED (deck ~3x higher; likely RoU/other-income inclusion) — filing wins | A3-05/F12 |
| C5 | "+57% ... Continued growth" framed as organic (l.104, l.108) | +71% continuing rev is full-quarter PropTiger consolidation; Q1 FY26 had zero PropTiger; organic ex-PropTiger not disclosed | CONTRADICTED framing (inorganic presented as organic) | A3-13 |
| C6 | Slide 4 "Others 9" vs Slide 5 "Capital ₹2 Cr" | Two figures do not reconcile even after the Rs.6.24 Cr unallocable-expense footnote (l.167); Capital/SM-REIT still loss-making | UNVERIFIABLE / internal inconsistency | A3-05 |
...
Contract: every A3 FORWARD-SIGNAL (A3-02, 03, 04, 07, 09) and AMBIGUOUS (A3-01, 05) finding generates ≥1 row. Rows folded/de-duplicated against the 10 concall questions already logged in the 2026-07-20 filing review; NEW deck-specific questions are marked [NEW]. Ordered by materiality.
...
| Item | Implied date | Status word | Source ref |
|---|---|---|---|
| Housing.com 100% acquisition close; all-equity 1,97,93,309 shares to REA (→24.9%) | Board-approved 16-Jul-2026; closure pending → Q2 FY27 | approved | slide 9, l.274/298-300 (A3-02) |
| AREDL 51-lakh FCW pricing (promoter, preferential) | Approved 16-Jul-2026; pricing undisclosed → Q2 FY27 | approved, price ND | filing/Notion item 9 (A3-04/A3-07) |
| Housing.com joins ecosystem (PropTiger/NestAway/HelloWorld/Sell.do/Aurum Analytica) | open-ended | announced | slide 9, l.297-300 (A3-09) |
| AI-first re-architecture of core CRM platform | none stated → track to "completed" next deck | underway | slide 8, l.256 (A3-03) |
| Site-visit success POCs (outcome-based pricing) | none stated | underway | slide 7, l.230-233 |
...
decision_status_verified: "AVOID at CMP Rs.240; entry zone Rs.71-89, MoS Rs.71; Position None"
position_branch: "8A-W"
sc_gap_pat_pct: ["ND (deck consolidated-only; standalone column N.A. by doctype)","substitute quality-of-earnings gap Q1FY27: continuing PAT -0.34 vs reported PAT 45.18 = ~100%+ one-time-gain gap"]
questions_for_management:
  ...
  - {q: "Confirm Housing.com/Locon consolidation timing and pro-forma revenue/goodwill; provide organic revenue ex-PropTiger YoY.", from_finding_id: "A3-09/A3-13"}
  - {q: "AI core-platform re-architecture 'underway' - completion date and quantum of monetized AI/ecosystem revenue today?", from_finding_id: "A3-03"}
  - {q: "Goodwill Rs.174.25 Cr (61% of net worth) impairment-test status; over-1yr receivables trend; MSKA consent-withdrawal and internal-auditor-change rationale - all absent from the deck.", from_finding_id: "A3-14"}
  - {q: "Rental deck segment profit Rs.2 Cr vs filing Rental EBIT +Rs.0.63 Cr - what bridges the ~3x gap, and is breakeven durable into Q2/Q3?", from_finding_id: "A3-05/C4"}
monitorables:
  - {item: "Housing.com 100% acquisition close (REA ->24.9%, 1,97,93,309 shares)", implied_date: "Q2 FY27 (board-approved 16-Jul-2026)", source_ref: "slide 9 l.274/298-300 / A3-02"}
  - {item: "AREDL 51-lakh FCW pricing (promoter, preferential)", implied_date: "Q2 FY27 (approved 16-Jul-2026, price ND)", source_ref: "Notion item 9 / A3-04/A3-07"}
...
flags: ["NARRATIVE-VS-EVIDENCE","ONE-TIME-ITEM","PROMOTER-CONCERN","CASH-INDETERMINATE","GOODWILL-IMPAIRMENT-RISK","SHARED-CATALYST","SELF-UNDERCUT","DILUTION-TWO-LEGS-ONE-OMITTED","SELECTIVE-DISCLOSURE","DATA_GAP_PRIOR_LEDGER","CONTROL-QUALITY","ROLE5-NA-NO-TRANSCRIPT"]
review_path: "/home/user/inflection-pipeline/runs/aurum-q1fy27/work/review_aurum_q1fy27.md"
```
