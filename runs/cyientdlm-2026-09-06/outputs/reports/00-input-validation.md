...
- **No announcements.** Stages 5, 7 and 8 lose the documented-ACTION record.
  ...
  material events.
- **No shareholding.** Stage 10 marks FII+DII unresolved. Phase 3 cannot
  affirm the UA institutional-absence qualifier, so UA is withheld under the
  all-three-qualifier rule. Promoter holding and pledge trend fall back to the
  AR figure with staleness noted.
...
input_gaps:
  ...
  - type: shareholding
    status: ABSENT
    priority: MEDIUM
    reason: "FII+DII unresolved. UA qualifier cannot be affirmed in phase 3."
  - type: research
    status: ABSENT
    priority: LOW
