COPY THESE SIX FILES HERE FROM YOUR CLAUDE.AI PROJECT BEFORE THE
...
retired). Stage 11 injects all four Section 1B layers; where they
overlap, v3.7 governs the items it names, then v3.6, then v3.5.1,
then v3.3.
