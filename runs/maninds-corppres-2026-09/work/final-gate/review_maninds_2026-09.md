...
|---|---|---|---|---|---|---|
| Standalone FY26 | 4,928 (R153) | 531 (R150) | 4,397 | 34,552 (R149) = 12.7% | 14.0% (R154) | above floor by 0.3pp (clean) |
...
Read: on the reported basis the consolidated FY26 EBITDA margin (13.0%) sits exactly at the Notion
tripwire floor. On a clean basis (ex Other Income, per MF04) it is 12.3%, BELOW the 13% floor and far
from the 15% five-year target (R222). The Notion tripwire "EBITDA margin ex-other-income vs 13% floor"
is TOUCHED on the consolidated read. FLAG. Not a formal auto-fire trigger; the human decides.
...
| Order book at acquisition | — | 120.0 | 1,130-1,150 Cr | — | R144 |
| Financing | — | 70 debt + 32 equity | — | — | R092/R093 |

FX disclosed: SAR/INR 23.955, SAR/USD 3.75 pegged (R145/R146). NPC EBITDA margin 24.8% and ROCE 29.5%
are roughly double the parent's clean 12.3% / headline 18.4%. NPC is the entire re-rating case and it
consolidates only from Q2 FY27 (R286/R334). Every full-year FY26 number in 2.1-2.7 is the OLD business.
...
| EBITDA margin ex-other-income vs 13% floor | Clean consol 12.3%, BELOW floor (2.3) | TOUCHED, adverse |
...
| NPC acquisition economics & integration | NPC 24.8% EBITDA / 29.5% ROCE; consolidates Q2FY27 | ON TRACK, unproven in numbers |
...
margin-thin, WC-heavy business, and three watch tripwires are touched adverse. The re-rating case
(NPC economics) is real on paper but appears in group numbers only from Q2 FY27. Entry discipline
holds: CMP Rs714 is above the Rs412-589 entry zone; nothing here argues to buy above the zone.
...
| Q3 | From what quarter does full NPC earnings contribution land, and what is the expected FY27 group revenue and EBITDA-margin uplift from NPC's 24.8% EBITDA / 29.5% ROCE mix? | A2 (F6, FORWARD-SIGNAL) |
| Q4 | Headline EBITDA (standalone 14.0%, consolidated 13.0%) is "inclusive of Other Income". On a clean, ex-Other-Income basis the consolidated FY26 margin is 12.3%, below the 13% level. What is the clean-margin path to the stated 15% target, and does headline ROCE 18.4% hold on a clean-EBIT basis? | A6 (F16, FORWARD-SIGNAL) |
...
| NPC full earnings contribution (first clean quarter) | Q2 FY27 | R286/R334 | group EBITDA-margin lift toward 15% |
...
1. Consolidated clean EBITDA margin 12.3% is below the Notion 13% floor tripwire (Step 2.3).
...
and Role 1 valuation. Load-bearing downstream input: NPC's 24.8% EBITDA / 29.5% ROCE mix vs the
parent's clean 12.3% / 18.4%, and whether the blended clean group margin actually reaches 15%.
...
The headline EBITDA margin (13.0% consolidated) includes Other Income. Strip it out and the clean
margin is 12.3%, below the 13% level the thesis watches and far from the 15% target. Working capital
grew far faster than sales: inventories 2.4x, receivables 2.8x over two years on flat revenue. Capital
work-in-progress rose almost 11x for the Jammu and Dammam plants, which earn nothing yet. The deck
carries no cash-flow statement, so cash quality cannot be proven. One balance-sheet line, "other
financial liabilities", jumped from Rs301 Mn to Rs5,797 Mn; if that is the acquisition payable, the
company is net debt, not net cash. The company also raised equity (paid-up capital up 15.7%) and did
not disclose diluted EPS.

The whole re-rating case is the Saudi target, National Pipe Company. Its own numbers are strong: 24.8%
EBITDA margin, 29.5% ROCE, an order book of about USD 120 Mn. But it consolidates only from Q2 FY27;
...
26-32). Clean margin, net-debt reading, and subsidiary decomposition are A4-derived from anchored rows.
...
move margins. Regulation and payer mix are not consumer-style factors here; the "payer" is national
oil companies and utilities, and the risk is tender timing and receivable cycles, both visible in the
2.8x receivable build (R201). Metric the deck did NOT disclose: India order-book split and book-to-bill.
...
(Jammu, R276) and value-added coating (Dammam, R275). The FY26 clean EBITDA margin of 12.3% (A4-derived
from R165/R162/R161) is consistent with a converter, not a franchise. The transition thesis rests on
three mix shifts: buy the higher-margin Saudi plant (NPC EBITDA 24.8%, R124), add stainless seamless
(Jammu, targeted Mar 2027, R274), and add coating (Dammam, targeted Mar 2027, R273). This quarter's
model drift signal is adverse on the base business: working capital rose faster than revenue and the
non-NPC subsidiaries turned loss-making (Step 4). The model only re-rates if NPC's economics survive
consolidation AND the clean group margin actually climbs to 15% (R222). Metric NOT disclosed: per-
subsidiary and per-product-line P&L, so the mix shift cannot yet be verified in the numbers.
...
approval is a real switching barrier in Gulf tenders and is the load-bearing moat claim. Where it is
structurally weaker: it is a price-taking converter exposed to steel input costs, with a lumpy order
...
cycle slows, or if steel spreads compress, the thin 12.3% clean margin has little cushion, and the
receivable and inventory build (R201/R199) becomes a cash trap. The NPC acquisition is the edge; if
its economics do not survive consolidation from Q2 FY27, the competitive case reverts to a
margin-thin converter. Metric NOT disclosed: market share and win-rate vs named peers.
...
questions_for_management:
  ...
  - {q: "From which quarter does full NPC earnings land, and what FY27 group revenue/EBITDA-margin uplift is expected from NPC's 24.8% EBITDA / 29.5% ROCE mix?", from_finding_id: "A2"}
  - {q: "Headline EBITDA includes Other Income; clean consol FY26 margin is 12.3%, below 13%. What is the clean-margin path to 15%, and does ROCE 18.4% hold on a clean-EBIT basis?", from_finding_id: "A6"}
...
monitorables:
  ...
  - {item: "NPC full earnings contribution (first clean quarter)", implied_date: "Q2 FY27", source_ref: "R286/R334"}
...
flags:
  - "Clean consol EBITDA margin 12.3% below Notion 13% floor tripwire (touched adverse)"
...
analyst_note: "Two threads. First, the deck flatters the present: EBITDA and Total Income both carry Other Income (MF02/MF04), so clean consol margin is 12.3%, under the 13% Notion floor and far from the 15% target; ROCE 18.4% rides the same incl-OI EBIT (clean ROCE ND). Second, FY26 is the OLD business, pre-NPC: 10.7x CWIP build and WC ballooning (inv 2.4x, recv 2.8x) on flat +1.7% consol revenue, subs flipped +162 to -253 PAT, subsidiary revenue down ~72%. NPC (24.8% EBITDA, 29.5% ROCE) is the entire re-rating case and consolidates only from Q2 FY27. Verdict PROCEED WITH FLAGS, capped by INDETERMINATE cash conversion (no CF statement). The Rs5,797 other-financial-liability (candidate NPC payable) decides net cash vs net debt. Decision Status stays WATCHLIST; CMP Rs714 above the Rs412-589 zone; no trigger fired. Downstream must test whether blended clean group margin truly reaches 15% post-NPC."
review_path: "runs/maninds-corppres-2026-09/work/final-gate/review_maninds_2026-09.md"
```
