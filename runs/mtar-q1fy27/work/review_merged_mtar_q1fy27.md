# MTAR Technologies Limited (MTAR) — Q1 FY27 MERGED Quarterly Results Review
...
Results ledger: 11 notes / 68 line items / 7 agenda / 26 auditor paras / 3 entities. Press-release ledger: 26 financial numbers / 5 segment claims / 3 MD sentences / 14 admin (full A2 count 54 rows incl. 1 operational metric + 5 footnotes/disclaimer; 100% reconciled). Presentation ledger: 32 slides / 535 numbers / 7 footnotes / 9 zero-standing. **ALL reviewed.** No ledger row is unreviewed; all three A3 gates PASS at 100% reconciliation.

**Findings incorporated (all three forensics files):**
- Results (forensics_mtar_q1fy27.md): **F6-a, F8-a, F13-a, F14-a, F14-b, F14-c**
- Press release (forensics_pressrel_mtar_q1fy27.md): **A3-F6-01, A3-F6-02, A3-F7-01, A3-F14-01, A3-F16-01**
- Presentation (forensics_presentation_mtar_q1fy27.md): **F-01, F-02, F-03, F-04, F-05, F-06, F-07, F-08, F-09, F-10, F-11, F-12, F-13**

Every FORWARD-SIGNAL and AMBIGUOUS finding above generates ≥1 Questions-for-Management row (Step 8.5). No finding is left unprocessed.

---

## STEP 0 — PRE-FLIGHT

**0A. Notion / Decision Status (VERIFIED before any framing).**
- **Decision Status = WATCHLIST — AVOID at CMP ₹7,210** (May-26 page). Position: None; Small (2–3%) only when entry triggers fire.
- Gate 0 GOOD (105/160); EM Score 33/100 (Moat Strengthening); Promoter Verdict TRUSTWORTHY-with-flags.
- Entry zone (25% CAGR) ₹1,737–2,084 (verdict card) / ₹1,497–1,796 (Sec 4E). MoS ₹1,389 / ₹1,197. BUY ≤₹1,197 | ADD ₹1,197–1,796 | WATCHLIST ₹1,796–2,635 | **AVOID >₹2,635**. CMP ₹7,210 is ~3.5x the top of the entry zone → the AVOID is a **valuation** stance, not a quality stance. This branch is **8A-W (non-held name).**
- Destination PE 40x (peer-validated). FY31 base PAT ₹420–485 Cr; base FV ₹4,570–5,300.

**0B. Unit convention.** Results filing = **INR Millions** (×0.1 → ₹ Cr). Press release & presentation = **₹ Crores** (×1). All figures converted to ₹ Cr. Reconciliation across all three docs performed (see Step 1 note); residual break = ZERO on values — the only cross-doc break is a **column-header label typo** (F-07, slide 12 headed "Q4 FY25" for values that are Q1 FY26).

**0C. Share-count changes.** NONE. Paid-up equity ₹307.59 M flat across all four periods, both statements (L350 standalone / L421 consol). Outstanding shares 3,07,59,591 (S31-1). Basic EPS = Diluted EPS every period, both statements (16.33=16.33 consol Jun-26, L424/L425) → no dilutive instruments. EPS comparisons are clean, no share-adjustment needed.

**0D. Notes extraction (mandatory full table).** Consolidated notes 1–6 (L429–441); standalone notes [1]–[5] (L359–369, leading-digit glyphs dropped by renderer, positional numbering confirmed by A2 against in-table anchors).

| Note # | Subject | What it says (1 sentence) | ₹ Cr Impact | Period Affected | Comparability Impact |
|---|---|---|---|---|---|
| Consol 1 (L429) | Group composition | Group = MTAR + Gee Pee Aerospace + Magnatar Aero Systems (2 WOS) | — | All | Defines consol scope; both WOS under pending NCLT merger (F6-a) |
| Consol 2 / Std [1] (L431/L359) | Ind AS basis | Results prepared per Ind AS 34 | — | All | None |
| Consol 3 / Std [2] (L435/L363) | Balancing-figure note | Mar-26 quarter figures are **balancing numbers** between audited FY and 9M | — | Q4 FY26 | Q4 FY26 quarterly numbers are DERIVED, not independently reported — treat Q4 as residual |
| Consol 4 / Std [3] (L437/L365) | **NCLT merger scheme** | Scheme filed to merge both WOS into the holding company (F6-a) | ND (undated, pending sanction) | Prospective | Consolidation scope WILL change on effectiveness; S-vs-C gap collapses to zero post-merger |
| Consol 5 / Std [4] (L439/L367) | Single segment | Business is a **single Ind AS 108 segment** | — | All | Statutory single-segment; the deck's 4-vertical split (S7–S10) is VOLUNTARY/unaudited (F-12) |
| Consol 6 / Std [5] (L440/L368) | Exceptional item | FY26 exceptional = one-time ₹37.67 M (₹3.77 Cr) Labour-Codes provision (F14-c label variance "Code"/"Codes") | 3.77 (FY26 only) | FY26 | One-off; NIL in Q1 FY27 and Q1 FY26 — add back for FY26 trajectory; does not recur |
| — (L342/L413) | Prior-period tax (F8-a) | "Adjustment of tax relating to earlier periods (8.26)" M = ₹0.83 Cr credit | +0.83 (FY26/Q4 FY26 only) | Q4 FY26 / FY26 | One-time; inflated FY26 PAT base by ₹0.83 Cr; NIL in Q1 FY27 and Q1 FY26 — does not recur |

**Auditor opinion check:** **UNMODIFIED (clean)** on BOTH standalone (conclusion L512–524) and consolidated (L620–634). No EoM, no Going Concern. Consolidated carries an Other-Matters-type disclosure (L637–646): two subsidiaries reviewed by other auditors, revenue ₹1.68 Cr (0.47% of consol revenue), net loss ₹0.72 Cr (1.44% of consol PAT) — below the 10% F4 threshold; principal auditor relies "solely on the report of such auditors" (standard caveat). **Two governance data-points logged (not opinion modifications):** (i) F14-b — consolidated review report carries **NO UDIN** in its signature block (L679–692) vs standalone UDIN present (L537); AMBIGUOUS (genuine omission vs extraction line-drop) → verify at source PDF. (ii) F14-a — Membership No. "4777" (consol L687) vs "504777" (standalone L535), same partner/day; likely dropped-glyph (standalone UDIN embeds "50477") → confirm at source.

**0E. Business type.** **Standard operating business** (precision engineering / manufacturing). Steps 1 and 5 apply; NOT a lender. CFO/PAT, WC days, inventory are meaningful.

🛑 Pre-flight complete: Notion + Decision Status verified, units identified, zero share-count change, all notes extracted, auditor opinion clean-with-two-governance-flags, standard business. Proceed.

---

## STEP 1 — DATA EXTRACTION TABLE (STANDARD BUSINESS)

All values ₹ Cr. Results filing INR M ÷10. **S = Standalone (filing p5); C = Consolidated (filing p6, = press release & deck basis).** Q4 FY26 = the Mar-26 quarter (a **balancing figure** per Note 3 — flagged). Line anchors are results-filing line numbers unless slide (S..) cited.

### 1a. CONSOLIDATED (matches press release & deck)

| Line Item | Q1 FY26 (Jun-25) | Q4 FY26 (Mar-26 Q) | Q1 FY27 (Jun-26) | FY25 | FY26 |
|---|---|---|---|---|---|
| Revenue from Operations | 156.58 (L396) | 306.07 (L396) | 360.72 (L396) | 676.0 (S25) | 876.21 (L396) |
| Other Income | 0.61 (L397) | 16.40 (L397) | 7.89 (L397) | 5.2 (S25) | 23.09 (L397) |
| Total Income | 157.19 (L398) | 322.46 (L398) | 368.61 (L398) | ND | 899.30 (L398) |
| Cost of Materials Consumed | 92.77 (L400) | 165.00 (L400) | 204.32 (L400) | 349.5 (S25) | 503.48 (L400) |
| Change in Inventories (WIP) | (21.09) (L401) | 5.66 (L401) | (7.82) (L401) | (7.6) (S25) | (45.07) (L401) |
| Employee Benefits Expense | 34.32 (L402) | 43.05 (L402) | 46.52 (L402) | 123.8 (S25) | 150.91 (L402) |
| Finance Costs | 5.82 (L403) | 9.62 (L403) | 15.85 (L403) | 22.2 (S25) | 29.36 (L403) |
| Depreciation & Amortisation | 8.37 (L404) | 9.04 (L404) | 9.69 (L404) | 32.2 (S25) | 35.03 (L404) |
| Other Expenses | 22.20 (L405) | 30.55 (L405) | 32.64 (L405) | 89.5 (S25) | 95.68 (L405) |
| Total Expenses | 142.38 (L406) | 262.92 (L406) | 301.21 (L406) | ND | 769.38 (L406) |
| Exceptional Items | — nil (L409) | — nil (L409) | — nil (L409) | 0.0 (S25) | 3.77 (L409) |
| Profit Before Tax | 14.81 (L410) | 59.54 (L410) | 67.40 (L410) | 71.6 (S25) | 126.15 (L410) |
| Tax Expense | 4.00 (L415) | 15.26 (L415) | 17.18 (L415) | 18.7 (S25) | 32.12 (L415) |
| PAT | 10.81 (L416) | 44.28 (L416) | 50.23 (L416) | 52.9 (S25)† | 94.03 (L416) |
| EPS reported (₹) | 3.52 (L424) | 14.40 (L424) | 16.33 (L424) | ND | 30.57 (L424) |
| EPS share-adjusted (₹) | 3.52 (=basic) | 14.40 (=basic) | 16.33 (=basic) | ND | 30.57 (=basic) |

† FY25 consol PAT: deck self-disagrees 52.9 (S25 P&L) vs 53.4 (S29 chart) — F-08, immaterial ₹0.5 Cr; no FY25 in filing to arbitrate; verify at FY26 AR.

### 1b. STANDALONE (filing p5)

| Line Item | Q1 FY26 (Jun-25) | Q4 FY26 (Mar-26 Q) | Q1 FY27 (Jun-26) | FY26 |
|---|---|---|---|---|
| Revenue from Operations | 156.58 (L325) | 306.03 (L325) | 360.72 (L325) | 876.11 (L325) |
| Other Income | 0.76 (L326) | 16.54 (L326) | 8.04 (L326) | 23.69 (L326) |
| Finance Costs | 5.82 (L332) | 9.61 (L332) | 15.85 (L332) | 29.34 (L332) |
| Depreciation & Amortisation | 8.19 (L333) | 8.88 (L333) | 9.48 (L333) | 34.36 (L333) |
| Profit Before Tax | 15.20 (L339) | 59.61 (L339) | 67.64 (L339) | 127.27 (L339) |
| Tax Expense | 3.97 (L344) | 15.27 (L344) | 17.14 (L344) | 31.95 (L344) |
| PAT | 11.23 (L345) | 44.34 (L345) | 50.50 (L345) | 95.32 (L345) |
| EPS reported / adjusted (₹) | 3.65 (L354) | 14.41 (L354) | 16.42 (L354) | 30.99 (L354) |

### 1c. DERIVED METRICS (CONSOLIDATED)

| Derived Metric | Formula | Q1 FY26 | Q4 FY26 | Q1 FY27 | FY26 |
|---|---|---|---|---|---|
| Operating EBITDA | PBT + D + FC − OI | 28.39 | 61.80 | 85.05 | 167.45 (+3.77 excep = 171.2 deck) |
| Operating EBITDA Margin | OpEBITDA / Rev | 18.1% | 20.2% | 23.6% | 19.1% (19.5% deck, incl. excep add-back) |
| Reported EBITDA | PBT + D + FC | 29.00 | 78.20 | 92.94 | 190.54 |
| Core PBT (ex-OI) | PBT − OI | 14.20 | 43.14 | 59.51 | 103.06 |
| Other Income / PBT | OI / PBT | 4.1% | 27.5% | 11.7% | 18.3% |
| Effective Tax Rate | Tax / PBT | 27.0% | 25.6% | 25.5% | 25.5% |
| PAT Margin | PAT / Rev | 6.9% | 14.5% | 13.9% | 10.7% |

Deck's Q1 FY27 EBITDA 85.1 / 23.6% (S11-12/S11-15) and PAT 50.2 / 13.9% (S11-24/S11-27) tie to the paise. **Deck "EBITDA" EXCLUDES Other Income** (A3-F14-01): 85.05 = Rev-from-ops − [materials + Δinv + employee + other expenses]. Had OI been included it would read ~₹92.9 Cr. Definition logged for cross-quarter like-for-like.

🛑 Every cell filled or ND. Proceed.

---

## STEP 2 — Q1 FY27 YoY COMPARISON (THE MOST IMPORTANT STEP) — Consolidated
...
| Other Income | 0.61 | 7.89 | +1193% | Large %, tiny base; 11.7% of PBT |
| **Core Operating PBT (PBT−OI)** | 14.20 | 59.51 | **+319.1%** | **Cleanest test — genuinely strong, NOT treasury-driven** |
| Reported PBT | 14.81 | 67.40 | +355.0% | Strong |
| PAT | 10.81 | 50.23 | +364.5% | Strong |
| EPS (share-adjusted) | 3.52 | 16.33 | +363.9% | Clean (no dilution) |
...
6. **Other Income concentration?** Q1 FY27 OI ₹7.89 Cr is 11.7% of PBT, DOWN from Q4 FY26's 27.5% (₹16.40 Cr, treasury-heavy). Stripping OI, core trajectory is intact — Q1 is a *clean operating* quarter, unlike Q4 FY26.

🛑 YoY table + six diagnostics shown. Proceed to QoQ.

---

## STEP 3 — SEQUENTIAL QoQ TRAJECTORY (Consolidated)

Filing/deck supply only Q1 FY26, Q4 FY26, Q1 FY27 quarterly P&L. Q2/Q3 FY26 quarterly financials are **not in any of the three documents** → ND (Notion memory: Q3 FY26 margin ~23%, order book ₹2,582 Cr — that is memory, not doc-anchored).

| Quarter | Revenue (₹ Cr) | Op EBITDA Margin | Core PBT ex-OI (₹ Cr) | One-offs Flagged | QoQ Run-Rate |
|---|---|---|---|---|---|
| Q1 FY26 | 156.58 (L396) | 18.1% | 14.20 | — | base |
| Q2 FY26 | ND | ND | ND | ND | ND |
| Q3 FY26 | ND (Notion memory ~23% margin, OB ₹2,582 Cr) | ND | ND | ND | ND |
| Q4 FY26 | 306.07 (L396) | 20.2% | 43.14 | balancing figure (Note 3); OI-heavy (27.5% of PBT); prior-period tax credit ₹0.83 Cr (F8-a); Labour-Codes excep ₹3.77 Cr (FY26 only) | step-up |
| Q1 FY27 | 360.72 (L396) | 23.6% | 59.51 | clean quarter | **stepping up** |

**Diagnostics:**
- **Run-rate trajectory:** STEPPING UP. Revenue +17.9% QoQ (306.07→360.72); Op EBITDA +37.6% QoQ (61.80→85.05); core PBT +37.9% QoQ (43.14→59.51). Margin recovered from an OI-flattered Q4 to a clean 23.6% Q1.
- **Distorted quarters:** Q4 FY26 is a *balancing figure* (Note 3) and OI-heavy (27.5% of PBT); its 14.5% PAT margin overstates operating quality. Q1 FY27 is cleaner (OI 11.7% of PBT).
- **Implied Q2 FY27 base to hold trajectory:** to stay on the raised 80% FY27 guide (₹1,577 Cr), Q2–Q4 must average ₹405.5 Cr/qtr (see Section b) — i.e. ~+12% above the Q1 ₹360.7 Cr run-rate.

🛑 QoQ shown. Proceed.

---

## STEP 4 — OPERATIONAL DECOMPOSITION (PAT bridge, Q1 FY27 vs Q1 FY26, Consolidated)

Reported PAT YoY change = ₹50.23 − ₹10.81 = **+₹39.42 Cr**.

| Component | YoY Change (₹ Cr) | YoY Change (%) | Recurring? |
|---|---|---|---|
| Revenue → gross-profit contribution (Rev +204.14; GP% 54.2%→45.5%) | +₹79.3 GP (84.9→164.2, +₹79.3) | GP +93.4% | Recurring |
| — of which volume/revenue effect | ≈ +₹110.7 (at Q1FY26 GP% 54.2% on +204.14 rev) | — | Recurring |
| — of which GP-margin change effect | ≈ −₹31.4 (GP% 54.2%→45.5%, −8.7pp on ₹360.72) | — | Recurring (mix: Products share ↑ to 28%, F-05) |
| Employee + Other-expense change | −₹22.64 (56.52→79.16) | — | Recurring |
| Operating-EBITDA net effect | +₹56.66 (28.39→85.05) | +199.6% | Recurring |
| D&A change | −₹1.32 (8.37→9.69) | +15.8% | Recurring (post-capex) |
| Finance-cost change | −₹10.03 (5.82→15.85) | +172.3% | Recurring (post-debt) |
| Other Income change | +₹7.28 (0.61→7.89) | +1193% | NON-RECURRING typically |
| Exceptional items | 0 (nil both Q1s) | — | n/a this qtr |
| Effective-tax-rate change (27.0%→25.5%) | +₹0.9 approx | — | Mixed |
...
🛑 Bridge shown. Proceed.

---

## STEP 5 — CASH QUALITY & BALANCE SHEET

**Data-availability rule (v1.2):** Reg 33 mandates half-yearly CFO/balance sheet; **Q1 marks CFO ND.** The **bare Q1 filing** had no balance sheet and no CFO. The **DECK now supplies** a full FY26 balance sheet (slides 26/27, at **Mar-26**), an FY26 abridged cash flow (slide 28), WC days at **Jun-26** (slide 14), and D/E + ROCE/ROE (slide 30) — a real upgrade over the bare filing. **BUT:** the deck gives NO **Jun-26** balance sheet and NO **Q1 FY27** cash-flow statement. So for **Q1 FY27 CFO/PAT specifically, the classification remains INDETERMINATE.**

| Metric | Prior period | Current period | Change | Verdict / Anchor |
|---|---|---|---|---|
| CFO (Q1 FY27) | — | **ND** | ND | **No Q1 cash flow (Reg 33 half-yearly); INDETERMINATE for the quarter** |
| CFO/PAT (Q1 FY27) | — | **ND** | ND | INDETERMINATE — house rule caps verdict at PROCEED WITH CAVEATS |
| CFO (FY, annual context) | FY25 101.3 (S28) | FY26 196.9 (S28) | +94.5% | Deck-supplied; FY26 CFO/PAT = 196.9/94.0 = **2.09x** (single strong year; Notion 8-yr cumulative 0.65x — NOT structural) |
| Capex proxy (PPE+CWIP, Mar-26) | Mar-25 489.3 (436.1+53.2) | Mar-26 531.6 (497.2+34.4) | +₹42.3 Cr | S26/S27; CWIP fell 53.2→34.4 (capitalised into PPE 436.1→497.2) |
| FCF (FY26, CFO−InvCF) | — | 196.9 − 352.6 = **−155.7** | — | S28; heavy investing outflow FY26 (facility build) |
| Working-capital change (FY26 CF) | FY25 −8.9 (S28) | FY26 +41.9 (S28) | swing +₹50.8 | WC RELEASED cash in FY26 (advance-driven, see below) |
| Receivable days | Q4 FY26 140 (S14-14) | Q1 FY27 82 (S14-13) | −58 days | Improved sharply |
| Inventory days | Q4 FY26 208 (S14-16) | Q1 FY27 145 (S14-15) | −63 days | Improved (RM 120→89; WIP 88→56) |
| Payable/Current-Liab days | Q4 FY26 176 (S14-22) | Q1 FY27 168 (S14-21) | −8 days | Roughly flat |
...
Notion projections are **FY31-terminal** (base PAT ₹420–485 Cr) with no per-quarter Bear/Base/Bull. The near-term anchors are the **FY27 revenue-growth guidance** and the monitoring checklist. Variance framed against those; annual FY31 targets are not quarter-comparable.

| Metric | Notion anchor | Q1 FY27 actual | Lands |
|---|---|---|---|
| Revenue growth (FY27) | old 50% guide → new 80% guide | +130.4% YoY (soft base); Q1 = ₹360.7 Cr (22.9% of 80% target ₹1,577 Cr) | Ahead of run-rate needed for old guide; on/slightly behind pace for new 80% guide (needs H2 step-up) |
...
| # | Watchlist Item | Green | Red | Q1 FY27 Reading (anchor) | Status |
|---|---|---|---|---|---|
...
| Thesis-Broken Condition | Threshold | Current Reading (anchor) | FIRED? |
|---|---|---|---|
| 1. Bloom backlog growth <20% YoY for 2 consec Q | <20% ×2Q | CANNOT COMPUTE (no prior-deck backlog); CE OB ₹3,431 Cr (S9-11); revenue proxy strong | **NO** (data insufficient) |
| 2. Bloom second-source SOFC >25% capacity | announced | SILENT everywhere (F-11 deck note) | **NO** |
| 3. MTAR FY28 fuel-cell revenue <₹800 Cr | <₹800 Cr FY28 | Future; CE annualising ~₹883 Cr | **NO** (on track) |
| 4. ROCE <15% for 2 consec years post-FY28 | <15% ×2yr | FY26 ROCE 17.2% (S30-4); FY25 was 11.4% (S30-3) — pre-window | **NO** (not yet in window) |
| 5. Promoter stake <25% (major selling round) | <25% | **29.35%** Jun-26 (S31-20) | **NO** — but declining (see Section d) |

**No thesis-broken condition has FIRED.** No pre-committed exit/avoid-reclassification trigger fires this quarter.

### 6D. Growth Trigger Status

| Trigger | Original Confidence | Confirming Evidence (anchor) | Killing Evidence | Updated Status |
|---|---|---|---|---|
...
## STEP 7 — FOUR-PILLAR RE-VALIDATION (flag only; no re-rate — no trigger fired)

The deck makes several pillar INPUTS visible for the first time. Per discipline, these are **flagged**, not silently re-rated; Decision Status changes only on a fired trigger (none fired). Pillar 1 ROCE selection is the FTTCP verdict's sole authority — NOT revised here.

| Pillar / Input | Original Assumption (Notion) | Current Reading (anchor) | Action |
|---|---|---|---|
| ROCE Base (0.5×ROCE+7.5, floor 9x cap 24x) | destination PE 40x context | **FY26 ROCE 17.2%** (S30-4) → naive 0.5×17.2+7.5 = 16.1x; FY25 was 11.4% (S30-3) | **FLAG: ROCE now visible & >15%.** Do NOT re-run Pillar 1 here — route to FTTCP (sole authority). FY26 is one recovery year after FY25 dip |
| Cash Multiplier | band assumed in valuation | Q1 CFO **ND**; FY26 CFO/PAT 2.09x but 8-yr 0.65x, FCF/PAT −0.51x (Notion) | **HOLD low** — one advance-driven year is not structural; INDETERMINATE this quarter |
| Growth Visibility Premium | +x | OB ₹5,143 Cr (5.9x FY26 rev); 80% guide (F-09); 16 dated commitments (F-02) | **FLAG up-bias**, but definition-watch on OB; hold pending FTTCP |
| Strategic Premium (single-credit rule) | +x; "ROCE recovery credited via: ___" | ROCE recovery visible; margin recovery visible | **HOLD** — do NOT credit ROCE recovery AND margin recovery as two mechanisms (single-credit rule) |
| UA Multiplier | per Notion | low institutional ownership NOT a risk; FII now 24.80% (S31-21) | **HOLD** |
| Sector Cap | per Notion | no reclassification | **HOLD** |
| Hurdle Ratio | HR = (1+EPS CAGR)³ × (Dest PE mid ÷ Current PE) ≥1.953 | CMP ₹7,210 vs dest PE 40x; at ₹7,210 the price already embeds the transition → HR fails at CMP | **STOP at CMP** (consistent with AVOID); recompute only at entry-zone prices |

**No pillar is re-rated. Destination PE unchanged (40x). No fired trigger → no fair-value recompute mandated.** The visible ROCE (17.2%) and margin (23.6%) are logged as *positive inputs to carry into the next FTTCP/Role 1 refresh*, not acted on here.

🛑 Pillar re-validation shown (flag-only). Proceed.

---

## STEP 8 — POSITION DECISION — Branch 8A-W (NON-HELD / WATCHLIST)

**Decision Status VERIFIED (Step 0A): WATCHLIST — AVOID at CMP ₹7,210.** Position: None. Therefore the **8A-W** branch governs (no trim/exit mechanics — nothing is held).

- **Any thesis-broken condition FIRED?** No (Step 6C). → do NOT reclassify to a harder AVOID-for-cause.
- **Actual below bear on 2+ metrics?** No — actuals are strong (Step 6A). → not the down-revision path.
- **Actual at/above base?** Operationally, yes (margin, core PBT, order book, ROCE all at/above the monitoring green thresholds).

**8A-W output:** Confirm/tighten entry zone; state gate. Results are operationally strong and several catalysts advanced (Kaiga order, margin 23.6%, OB ~2x, ROCE 17.2%). **BUT the AVOID is a valuation call, not a quality call:** CMP ₹7,210 is ~3.5x the top of the ₹1,737–2,084 entry zone and ~2.7x the AVOID line ₹2,635. **No pre-committed BUY gate is met** (BUY ≤₹1,197; ADD ₹1,197–1,796). **Decision Status UNCHANGED: WATCHLIST — AVOID.** The strong quarter raises quality conviction for *if-and-when* price mean-reverts; it does not authorise entry.

- **Entry zone:** UNCHANGED (₹1,737–2,084 verdict / ₹1,497–1,796 Sec 4E). Strong operating data argues *against* lowering it; do not raise it on one quarter. Recompute only after FTTCP/Role 1 refresh incorporates FY26 ROCE 17.2% and the 80% guide.
- **Master decision gate:** re-examine after (i) the FY26 Annual Report (imminent, pre-28-Sep-26 AGM — F13-a) and (ii) the H1 FY27 filing (Q2, first CFO reading). Gate pushed to **Q2 FY27 results / FY26 AR, whichever first.**

### 8B. Add-back / Trim triggers
- Not held → no trim ladder. **Re-entry watch (refined):** (i) H1 FY27 CFO/PAT confirming the WC improvement is NOT purely advance-reversal; (ii) nuclear backlog beginning to convert to revenue (Kaiga); (iii) promoter stake stabilising ≥ current 29.35% (not another sell-down toward 25%).

### 8C. Single Cleanest Metric for Q2 FY27
**Total NWC days sustained near ~59 WITH a positive H1 FY27 CFO/PAT ≥1.0x** — the cleanest test of whether the 274→59-day collapse is structural or an advance-funded, quarter-end-timing artefact (F-13).
- **Bull threshold:** H1 FY27 CFO/PAT ≥1.0x AND NWC days <120 with Other Current Liabilities NOT deflating faster than revenue grows → structural WC improvement confirmed.
- **Bear threshold:** NWC days spring back >200 as advances (₹254.9 Cr, S26-16) are consumed, and H1 CFO/PAT <0.65x → the improvement was timing; Pillar 2 cash multiplier stays capped low.

🛑 Position decision, triggers, single metric shown. Proceed.

---

# DEDICATED SECTION (a) — ADDITIONAL DETAIL FROM PRESS RELEASE + PRESENTATION
### Monitorables that were ND in the bare Q1 filing, now RESOLVED by the deck/PR

| Monitorable | Bare-filing status | Now resolved to (slide/PR anchor) | Reading | Verdict |
|---|---|---|---|---|
| Total order book & inflow | ND (single-segment filing, no OB) | Closing OB **₹5,143.3 Cr** 30-Jun-26 (S13-8); Q1 inflow **₹2,895.1 Cr** (S13-6); opening ₹2,581.9 Cr (S13-5) | ~2x Notion Q3 FY26 baseline ₹2,582 Cr; highest-ever single-qtr inflow | **GREEN** (definition-watch, F-10) |
| Clean Energy / Bloom revenue | ND | **₹220.8 Cr / 61%** Q1 FY27 (S9-5/S9-10); OB ₹3,431 Cr (S9-11) | Annualises ~₹883 Cr vs FY26 615.4 | **GREEN** (units silent) |
| Civil Nuclear revenue | ND | **₹3.2 Cr / 1%** Q1 FY27 (S7-5/S7-10) | Collapsed from 3% FY26 despite ₹504 Cr order | **AMBER** (F-04, backlog not converting) |
| Aerospace & Defence revenue | ND | **₹36.4 Cr / 10%** Q1 FY27 (S8-5/S8-10) | Steady; ~₹104 Cr FY26 | **GREEN** |
| Products & Others revenue | ND | **₹100.4 Cr / 28%** Q1 FY27 (S10-5/S10-10) | Spiked from 15% FY26 — largest-ever share, driver undisclosed | **AMBER** (F-05, mix/durability unknown) |
...
# DEDICATED SECTION (b) — GUIDANCE-CHANGE ASSESSMENT (F-09 / A3-F6-01)

**Change:** FY27 revenue-growth guide **RAISED 50% → 80%** and the **24% EBITDA margin PULLED FORWARD** from "by FY28" to the **current fiscal (FY27, ±100 bps)** — MD Parvat Srinivas Reddy, slide 4 (S4-1/S4-2/S4-3); "in line with the growth guidance" reaffirmed in the PR (A3-F6-01, p3 L112-113).

**Reconcile against the +130.4% Q1 YoY actual (soft-base caveat):**
- FY26 revenue = ₹876.2 Cr (S25). 80% → **FY27 target ≈ ₹1,577 Cr**; 50% → ₹1,314 Cr.
- Q1 FY27 = ₹360.7 Cr = **22.9%** of the ₹1,577 Cr target.
- The +130.4% Q1 YoY is **heavily base-inflated** — Q1 FY26 (₹156.6 Cr) was the softest quarter of FY26 (only 17.9% of the year). **Do NOT extrapolate 130% to the full year.**
...
# DEDICATED SECTION (c) — ORDER-BOOK INTEGRITY (F-10)

**The three figures reconciled:**
- **Stock (closing book):** Opening 31-Mar-26 **₹2,581.9 Cr** (S13-5) + Q1 inflow **₹2,895.1 Cr** (S13-6) − "sales restated at order book" **₹333.7 Cr** (S13-7) = **Closing 30-Jun-26 ₹5,143.3 Cr** (S13-8). **Waterfall ties exactly to two decimals.**
- **Flow (annual inflow):** FY26 full-year order inflow **₹2,453.3 Cr** (S13-15). This is a **flow** figure, distinct in kind from the two **stock** figures (opening/closing book). It is **reconcilable as a different measure**, not a contradiction: the deck's claim "Q1 inflow ₹2,895.1 Cr surpassing the entire FY26 inflow ₹2,453.3 Cr" is a valid flow-vs-flow comparison.
- Opening book ₹2,581.9 Cr ≈ Notion Q3 FY26 baseline **₹2,582 Cr** → the book was essentially flat Q3 FY26 → Mar-26, then doubled on the Q1 FY27 inflow.

**DEFINITION_WATCH conservatism applied:** The closing book is disclosed on a **"restated" basis — net of forex fluctuations, price escalations and scrap sales** (footnote F3, S13-7). **Gross-vs-net-of-GST and executed-vs-pending basis are NOT stated.** Per house discipline, **do NOT credit the "restated" ₹5,143.3 Cr at face value as the economic backlog** until the definition is obtained. Even conservatively, the doubling from the ₹2,582 Cr baseline is real and inflow-driven (Kaiga ₹504 Cr + Clean-Energy build to ₹3,431 Cr OB). **Verdict: FORWARD-SIGNAL, credited as directionally strong, quantum held at DEFINITION_WATCH** → A4 question on basis.

**Order-book segment-mix (S13-10..13: 66.7% / 13.3% / 12.6% / 7.4%):** slice-to-segment assignment is **ambiguous** in the deck layout (A2 DEFINITION_WATCH) → do not attribute the 66.7% to a named vertical without confirmation; likely Clean Energy given the ₹3,431 Cr CE OB (S9-11) is 66.7% of ₹5,143 Cr = ₹3,430 Cr (ties) → **CE ≈ 66.7% confirmed by arithmetic**, other three unassigned.

---

# DEDICATED SECTION (d) — PROMOTER-STAKE TRIPWIRE STATUS (F-03)

**Tripwire #5: promoter stake < 25% (another major selling round). STATUS: NOT FIRED.**

| Period | Promoter % | FII % | DII % | Public % | Anchor |
|---|---|---|---|---|---|
| Sep-25 | 31.41% | 9.21% | 24.81% | 34.58% | S31-8/9/10/11 |
| Dec-25 | 30.59% | 12.24% | 29.96% | 27.19% | S31-12/13/14/15 |
...
# DEDICATED SECTION (e) — REFRESHED THESIS-BROKEN & MONITORABLE TABLES (now data exists)

### Refreshed Thesis-Broken table
(Identical structure to 6C, now anchored to deck data rather than "not addressable from bare filing.")

| Condition | Threshold | Refreshed reading (anchor) | FIRED? | Change vs bare-filing review |
|---|---|---|---|---|
| Bloom backlog <20% YoY ×2Q | <20% | CE OB ₹3,431 Cr (S9-11); no prior-deck backlog to compute YoY | NO (insufficient) | Was fully ND; now revenue proxy visible |
| Bloom 2nd-source SOFC >25% | announced | Silent (deck) | NO | Unchanged |
| FY28 fuel-cell rev <₹800 Cr | <₹800 Cr | CE annualising ~₹883 Cr (S9-5) | NO (on track) | Now measurable via CE proxy |
| ROCE <15% ×2yr post-FY28 | <15% | FY26 17.2% (S30-4) | NO | Was ND; now visible |
| Promoter stake <25% | <25% | 29.35% (S31-20) | NO (4.35pp away) | Was ND; now visible & trending down |

### Refreshed Monitorable table

| Monitorable | Green | Q1 FY27 (anchor) | Status |
|---|---|---|---|
...
## STEP 8.5 — QUESTIONS FOR MANAGEMENT (every FORWARD-SIGNAL/AMBIGUOUS A3 finding → ≥1 row)

Channel: **AGM Q&A (28-Sep-2026) / IR email.** No concall transcript in scope. Ordered by materiality.

| # | Question | From finding(s) | Why it matters | Bull answer | Bear answer |
|---|---|---|---|---|---|
| 1 | The 80% FY27 revenue-growth guide (₹1,577 Cr) implies Q2–Q4 average ₹405.5 Cr/qtr vs ₹360.7 Cr in Q1. Which quarter do you expect to cross ₹400 Cr, and what is the H2 vertical mix? | F-09, A3-F6-01 | Tests whether the raise is deliverable or optics | Named quarter + Kaiga/Weatherford/Products ramp schedule | "second-half weighted" with no dates |
...
2. **Q2 (advance split of the ₹254.9 Cr)** — determines whether the 274→59-day WC collapse is structural or advance-funded (confirms/kills the WC monitorable).
3. **Q5 (promoter selling intent)** — tests management transparency on the nearest-to-firing tripwire (#5); evasion is itself a governance signal.

**Channel recommendation:** No concall scheduled. Submit Q1–Q5 at the **28-Sep-2026 AGM Q&A** and the full list via **IR email**; re-check answers at the FY26 Annual Report (imminent) and Q2 FY27 filing. Log any evasion in the Promoter Verdict (currently TRUSTWORTHY-with-flags).
...
ledger_reconciliation:
  ...
  turns: 0
  slides: 32
  press_release_financial_numbers: 26
  auditor_paras: 26
  all_reviewed: true
...
monitorables:
  ...
  - {item: "80% FY27 revenue guide - H2 acceleration to avg Rs 405.5 Cr/qtr", implied_date: "FY27 close", source_ref: "F-09/S4-1"}
  - {item: "FY26 Annual Report deep-dive (order book/segment/WC detail)", implied_date: "before 2026-09-28 AGM", source_ref: "F13-a"}
  - {item: "AGM (FY26) - submit Q1-Q5 management questions", implied_date: "2026-09-28", source_ref: "F13-a"}
