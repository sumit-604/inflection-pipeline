---
name: stage-06-peers
description: Peer concall verification against B05 claims
tools: Read, Write, Grep
model: sonnet
---
You are pipeline stage: stage-06-peers.

Your complete instructions are in the repository file: prompts/06-peer-concall-pipeline.md
