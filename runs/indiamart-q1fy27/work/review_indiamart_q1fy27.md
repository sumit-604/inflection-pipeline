# Q1 FY27 — COMPLETE QUARTERLY REVIEW (MERGED) — IndiaMART InterMESH Limited (INDIAMART)
...
**Ledger contains 14 notes / 0 concall turns / 69 slides** (plus, across the three A2 ledgers: results — 65 line items, 2 agenda items, 16 auditor paras, 13 entities, 5 signature blocks, 8 annexure rows; presentation — 462 numbers, 58 footnotes, 1 zero-standing row; press release — 3 headline bullets, 24 quantitative claims, 11 table line items, 1 management quote). **All reviewed** — every A2 row read verbatim at its cited line before judging; reconciliation 100% on all three documents.

**0 concall turns**: no concall transcript was supplied this quarter. The Q1 FY27 earnings **webinar** was scheduled for 21 July 2026 17:00 IST with the recording pending (press release L160-170). Role 5 therefore has **no primary concall document**. Role 4 is run in FULL; Role 5 is run as a clearly-labelled **partial substitute** using the press-release management narrative (CEO quote + highlights) only, NOT a transcript.

**Q1 data-availability note (Reg 33)**: the statutory filing is **P&L-only** — balance sheet and cash-flow statement are half-yearly (available at Q2/Q4), which is normal for Q1. The investor deck carries a summary abridged balance sheet (slides 38, 44) and a cash-generation table (slide 39); those deck figures are used for Step 5 with the ND caveats stated there. The full audited cash-flow statement is a Q2 FY27 monitorable.

**A3 findings incorporated (all IDs):**
- Results: F2-01, F4-01, F6-01, F6-02, F7-01, F12-01, F12-02, F13-01, F14-01, F14-02, F15-01, F15-02
- Presentation: F1-01, F6-01(p), F7-01(p), F10-01, F11-01, F11-02, F16-01, F16-02, F16-03, F16-04, F16-05, F17-01, F17-02, F17-03, F17-04
- Press release: F1-a, F16-a, F16-b, F16-c, F17-a, F17-b, F17-c, F17-d

No ledger row is unreviewed. Proceeding to Step 1.

---

# SECTION A — RESULTS REVIEW (ROLE 4, FULL)

## STEP 0 — PRE-FLIGHT

**0A. Notion (fetched live, verified BEFORE framing):** Decision Status = **HELD, 2% position** (trimmed from 3% post Q4 FY26). Frame against **HOLD (Step 8A branch)**, not exit. Cost Rs 2,015 | Entry Max Rs 1,439 | MoS Rs 1,151 | Destination PE 30x (revised from 38x). Gate 0 133/160 EXCELLENT; EM 41/100 MOAT EXPANSION UNDERWAY; Promoter TRUSTWORTHY-with-flags. One-line thesis: operating EPS Rs 53→78 over 3 yrs via ARPU expansion + Busy SaaS at 30x = ~Rs 3,067 base target = ~13.6% CAGR; thesis WEAKENED post Q4 FY26; **Q1 FY27 explicitly pre-flagged as the DECISION EVENT.**

**0B. Units:** Results filing "Amounts in INR million" (line 314, 612) → x0.1 to Rs Cr. Deck and press release native Rs Cr. Conversion applied and cross-checked (e.g., consol PAT 1,722 M x0.1 = 172.2 Cr ties to press-release Rs 172 Cr; standalone rev 3,759 M x0.1 = 375.9 Cr ties to Rs 376 Cr).

**0C. Share-count changes:** Paid-up equity 600 → 601 Cr-denominated face (600 M shares → 601 M; line 345/638), a routine ESOP allotment YoY; unchanged within the year (Q4FY26 601 = Q1FY27 601). Total shares outstanding 6,01,43,148 as on 30 June 2026 (deck L1791). Bonus issue of Q1FY24 already retro-adjusted in all EPS periods (deck footnote L1112). EPS comparisons valid. No split/QIP/FPO/buyback in the period. **F10:** single EPS line in deck, but statutory filing gives basic and diluted (spread ~0.1 INR) — no undisclosed dilution.

**0D. Notes (full extraction — 14 notes across the two filings):**

| Note # | Doc/Section | Subject | What it says (1 sentence) | Rs Cr impact | Period | Comparability impact |
|---|---|---|---|---|---|---|
| Consol N1 | lines 415-416 | Audit committee/board approval | Reviewed 20 Jul, approved 21 Jul 2026; **statutory auditors expressed UNMODIFIED opinion** | none | Q1FY27 | Clean opinion — no adjustment |
| Consol N2 | 419-420 | Basis of prep | Ind AS per s.133 | none | — | none |
| Consol N3 | 423-424 | Balancing figure | Q4FY26 (3M to 31 Mar 2026) figures are balancing (FY26 audited less 9M YTD) | none | Q4FY26 | **QoQ base for Q4FY26 is derived, not independently reported — treat QoQ with care** |
| Consol N4 | 425-426 | Availability | Results on BSE/NSE/company site | none | — | none |
| Consol N5 | 428-437 | Labour Codes | FY26 impact of notified codes already booked; remaining-state rules pending; Group to recognise consequential effect when notified | ND (undisclosed) | future | **Future employee-cost step-up, unquantified (F6-02, F7-01)** |
| Std N1 | 649-651 | Approval | Same; **UNMODIFIED opinion** standalone | none | Q1FY27 | Clean |
| Std N2 | 653-654 | Basis of prep | Ind AS | none | — | none |
| Std N3 | 656 | Segment disclosure | Segment info only in consolidated results (Ind AS 108) | none | — | none |
| Std N4 | 658-659 | Balancing figure | Q4FY26 standalone figures are balancing | none | Q4FY26 | Same QoQ caveat |
| Std N5 | 660-661 | Availability | On exchange sites | none | — | none |
| Std N6 | 663-672 | Labour Codes | Same as consol N5, standalone version | ND | future | Same (F6-02, F7-01) |
| Seg fn (a) | 402-403 | Segment definition | Operating-segment basis | none | — | none |
| Seg fn (b) | 405-406 | Two segments | Web & Related; Accounting Software | none | — | none |
| Seg fn (c) | 408-410 | Segment descriptions | Marketplace vs accounting-software business | none | — | none |

**Auditor opinion check:** **UNMODIFIED (clean)** in BOTH consolidated and standalone reports (lines 416, 650). No qualification, no emphasis-of-matter, no going-concern uncertainty (going-concern wording at lines 135-139/165-172/523-525/550-557 is Management/Auditor-Responsibility boilerplate only, per A3 F5). **Other Matters** flags carried forward as findings: (a) 4 subsidiaries audited by other auditors — pre-consol revenue Rs 2.725 Cr, net loss after tax Rs 6.475 Cr (lines 204-214); (b) 7 associates' share of net loss Rs 12.784 Cr on audited info, PLUS **IB MonotaRO stub (1 Apr–29 May 2026) share of net loss Rs 1.769 Cr fully UNAUDITED, board-furnished, deemed not material** (lines 215-227). Partner David Jones, B S R & Co. LLP, signed at Bali (an offshore signing location worth a note), UDINs 26098113QZDUTA5455 (consol) / 26098113OWPLAA6395 (standalone).

**0E. Business type:** **Standard operating business** (asset-light B2B marketplace SaaS + accounting-software subsidiary). Steps 1 and 5 apply, NOT the lender variant — **note the forward irony that the newly-approved IndiaMART Finance Ltd WOS (Agenda II) will, if funded, introduce a lending perimeter in future quarters** (F6-01/F13-01).

---

## STEP 1 — DATA EXTRACTION (both bases; every cell line-anchored or ND)

### 1A. CONSOLIDATED (Rs Cr; source lines from results filing 5A)

| Line Item | Q1 FY26 | Q4 FY26 | Q1 FY27 | FY26 |
|---|---|---|---|---|
| Revenue from Operations | 372.1 (L321) | 404.3 (L321) | 414.4 (L321) | 1,569.0 (L321) |
| Other Income | 92.4 (L322) | (33.9) (L322) | 106.7 (L322) | 204.1 (L322) |
| Total Income | 464.5 (L323) | 370.4 (L323) | 521.1 (L323) | 1,773.1 (L323) |
| Cost of Materials Consumed | ND (not applicable — no COGS line) | ND | ND | ND |
| Change in Inventories | ND (n/a) | ND | ND | ND |
| Employee Benefits Expense | 161.0 (L326) | 178.0 (L326) | 174.0 (L326) | 692.8 (L326) |
| Finance Costs | 1.0 (L327) | 0.6 (L327) | 0.5 (L327) | 3.0 (L327) |
| Depreciation & Amortisation | 6.9 (L328) | 7.0 (L328) | 6.4 (L328) | 28.4 (L328) |
| Other Expenses | 77.6 (L329) | 93.7 (L329) | 93.9 (L329) | 346.2 (L329) |
| Total Expenses | 246.5 (L330) | 279.3 (L330) | 274.8 (L330) | 1,070.4 (L330) |
| PBT before share of assoc. loss | 218.0 (L332) | 91.1 (L332) | 246.3 (L332) | 702.7 (L332) |
| Share in net loss of associates | (14.1) (L333) | (12.7) (L333) | (14.6) (L333) | (54.8) (L333) |
| Profit Before Tax | 203.9 (L334) | 78.4 (L334) | 231.7 (L334) | 647.9 (L334) |
| Tax Expense (total) | 50.4 (L339) | 28.2 (L339) | 59.5 (L339) | 173.2 (L339) |
| PAT | 153.5 (L341) | 50.2 (L341) | 172.2 (L341) | 474.7 (L341) |
| EPS basic (reported, share-adj) | 25.59 (L348) | 8.36 (L348) | 28.66 (L348) | 79.07 (L348) |
| EPS diluted (share-adj) | 25.52 (L350) | 8.33 (L350) | 28.56 (L350) | 78.77 (L350) |

### 1B. STANDALONE (Rs Cr; source lines 5C)

| Line Item | Q1 FY26 | Q4 FY26 | Q1 FY27 | FY26 |
|---|---|---|---|---|
| Revenue from Operations | 346.3 (L618) | 368.2 (L618) | 375.9 (L618) | 1,442.8 (L618) |
| Other Income | 84.4 (L619) | (33.9) (L619) | 88.1 (L619) | 190.8 (L619) |
| Total Income | 430.7 (L620) | 334.3 (L620) | 464.0 (L620) | 1,633.6 (L620) |
| Cost of Materials / Inventory | ND (n/a) | ND | ND | ND |
| Employee Benefits Expense | 148.5 (L623) | 162.0 (L623) | 157.1 (L623) | 634.4 (L623) |
| Finance Costs | 0.8 (L624) | 0.6 (L624) | 0.5 (L624) | 2.7 (L624) |
| Depreciation & Amortisation | 3.5 (L625) | 3.2 (L625) | 2.6 (L625) | 13.9 (L625) |
| Other Expenses | 63.1 (L626) | 71.6 (L626) | 69.5 (L626) | 288.1 (L626) |
| Total Expenses | 215.9 (L627) | 237.4 (L627) | 229.7 (L627) | 939.1 (L627) |
| Profit Before Tax | 214.8 (L628) | 96.9 (L628) | 234.3 (L628) | 694.5 (L628) |
| Tax Expense (total) | 48.8 (L632) | 27.3 (L632) | 58.2 (L632) | 169.3 (L632) |
| PAT | 166.0 (L633) | 69.6 (L633) | 176.1 (L633) | 525.2 (L633) |
| EPS basic (reported, share-adj) | 27.66 (L641) | 11.58 (L641) | 29.29 (L641) | 87.49 (L641) |
| EPS diluted (share-adj) | 27.59 (L643) | 11.54 (L643) | 29.20 (L643) | 87.15 (L643) |

### 1C. DERIVED METRICS (both bases)

| Derived Metric | Basis | Q1 FY26 | Q4 FY26 | Q1 FY27 | FY26 |
|---|---|---|---|---|---|
| Operating EBITDA (PBT-bef-assoc + D + FC − OI) | Consol | 133.5 | 132.6 | 146.5 | 530.0 |
| Operating EBITDA margin | Consol | 35.9% | 32.8% | 35.4% | 33.8% |
| Operating EBITDA (PBT + D + FC − OI) | Standalone | 134.7 | 134.6 | 149.3 | 520.3 |
| Operating EBITDA margin | Standalone | 38.9% | 36.6% | 39.7% | 36.1% |
| Reported EBITDA (incl. OI) | Consol | 225.9 | 98.7 | 253.2 | 734.1 |
| Reported EBITDA (incl. OI) | Standalone | 219.1 | 100.7 | 237.4 | 711.1 |
| Core PBT ex-Other Income (PBT − OI) | Consol | 111.5 | 112.3 | 125.0 | 443.8 |
| Core PBT ex-Other Income (PBT − OI) | Standalone | 130.4 | 130.8 | 146.2 | 503.7 |
| Other Income / PBT | Consol | 45.3% | (43.2%) | 46.1% | 31.5% |
| Other Income / PBT | Standalone | 39.3% | (35.0%) | 37.6% | 27.5% |
| Effective Tax Rate | Consol | 24.7% | 36.0% | 25.7% | 26.7% |
| Effective Tax Rate | Standalone | 22.7% | 28.2% | 24.8% | 24.4% |
| PAT margin (on revenue) | Consol | 41.3% | 12.4% | 41.6% | 30.3% |
| PAT margin (on revenue) | Standalone | 47.9% | 18.9% | 46.8% | 36.4% |

Deck reconciliation: consol Operating EBITDA 146.5 ties to deck "EBITDA 146" (L1100); standalone 149.3 ties to "EBITDA 149" (L1286); FY26 530/520 tie (L1100/L1286). Cross-check clean.

🛑 Every cell filled or ND. Proceeding.

---

## STEP 2 — Q1 FY27 YoY COMPARISON (the most important step; Q1 FY27 vs Q1 FY26)

### 2A. CONSOLIDATED

| Metric | Q1 FY26 | Q1 FY27 | YoY % | Verdict |
|---|---|---|---|---|
| Revenue from Operations | 372.1 | 414.4 | +11.4% | Positive; matches press "11%" |
| Operating EBITDA | 133.5 | 146.5 | +9.7% | Positive, lagging revenue |
| Operating EBITDA margin | 35.9% | 35.4% | −0.5pp (−50bps) | Slight compression |
| Depreciation | 6.9 | 6.4 | −7.2% | Immaterial (asset-light) |
| Finance Costs | 1.0 | 0.5 | −50.0% | Immaterial |
| EBIT (operating, EBITDA−D) | 126.6 | 140.1 | +10.7% | Positive |
| Other Income | 92.4 | 106.7 | +15.5% | Grew faster than revenue |
| **Core Operating PBT (PBT − OI)** | 111.5 | 125.0 | **+12.1%** | **Clean core growth > revenue** |
| Reported PBT | 203.9 | 231.7 | +13.6% | Positive |
| PAT | 153.5 | 172.2 | +12.2% | Positive; press "12%" |
| EPS diluted (share-adj) | 25.52 | 28.56 | +11.9% | Positive |

### 2B. STANDALONE

| Metric | Q1 FY26 | Q1 FY27 | YoY % | Verdict |
|---|---|---|---|---|
| Revenue from Operations | 346.3 | 375.9 | +8.5% | Positive; press "9%" |
| Operating EBITDA | 134.7 | 149.3 | +10.8% | Positive; press "11%" |
| Operating EBITDA margin | 38.9% | 39.7% | +0.8pp (+80bps) | **Expansion** |
| Depreciation | 3.5 | 2.6 | −25.7% | Immaterial |
| Finance Costs | 0.8 | 0.5 | −37.5% | Immaterial |
| Other Income | 84.4 | 88.1 | +4.4% | Modest |
| **Core Operating PBT (PBT − OI)** | 130.4 | 146.2 | **+12.1%** | **Clean core growth > revenue** |
| Reported PBT | 214.8 | 234.3 | +9.1% | Positive |
| PAT | 166.0 | 176.1 | +6.1% | Positive but tax-dragged; press "6%" |
| EPS diluted (share-adj) | 27.59 | 29.20 | +5.8% | Positive |

### Six mandatory diagnostics

1. **Did revenue grow YoY?** Yes. Consol +11.4% (372.1→414.4); standalone +8.5% (346.3→375.9). Both **below** the thesis's 25% CAGR aspiration but **in line with** the HOLD-case ~13.6% CAGR expectation (revenue is the standalone realization story; volume metrics are declining — see Step 6B). Busy Infotech carries consol above standalone (Busy revenue Rs 36 Cr, +47% YoY, deck L1224).

2. **Did operating EBITDA margin expand/contract/flat YoY?** Standalone **expanded**: Q1FY27 39.7% vs Q1FY26 38.9% = +80bps. Consol **compressed slightly**: 35.4% vs 35.9% = −50bps (Busy dilution and rising associate/other-expense drag). Both comfortably above the 30% thesis-break floor.

3. **Did core operating PBT (ex-OI) grow YoY?** **Yes, +12.1% on BOTH bases** — and this is the important tell: standalone core operating PBT (+12.1%) grew **faster** than reported standalone PAT (+6.1%). The headline PAT growth **understates** operational health; the gap is caused by (a) a higher effective tax rate (22.7%→24.8%) and (b) only +4.4% standalone Other-Income growth. This is the benign inversion of the usual warning — core operations are stronger than the headline, not weaker.

4. **What drove the gap between core operating PBT growth and reported PAT growth (standalone)?** Core +12.1% → PBT +9.1% (Other Income grew only +4.4%, diluting the mix) → PAT +6.1% (ETR rose +2.1pp, costing ~Rs 5 Cr of PAT). No exceptional items. On consol the effects offset (OI +15.5%, ETR roughly flat) leaving PAT +12.2% ≈ core +12.1%.
...
## STEP 3 — SEQUENTIAL QoQ TRAJECTORY (standalone, last 5 quarters)

| Quarter | Revenue (Rs Cr) | Op EBITDA margin | Op EBITDA (Rs Cr) | Core PBT ex-OI (Rs Cr) | One-offs flagged | QoQ run-rate |
|---|---|---|---|---|---|---|
| Q1 FY26 | 346 (deck L1382/1383) | 39% (L2011) | 135 (L1999/2000) | 130.4 | — | base |
| Q2 FY26 | 360 (L1382) | 32% (L2011) | 115 (L2000) | ND | +1.2K one-time supplier onboarding benefit inflates supplier base (F16-05, deck L1055) | dip (margin) |
| Q3 FY26 | 368 (L1382) | 37% (L2011) | 136 (L1999) | ND | — | recover |
| Q4 FY26 | 368 (L1382) | 37% (L2011) | 135 (L1999) | 130.8 | **Balancing figure** (N3); OI negative −33.9 | plateau |
| Q1 FY27 | 376 (L1382/1381) | 40% (L2011) | 149 (L1998) | 146.2 | — | **step-up** |

**Diagnostics:** Revenue run-rate is **gently stepping up** (346→360→368→368→376), +2.1% QoQ into Q1FY27. Standalone EBITDA margin recovered to **40%, the highest of the trailing 5 quarters**. Core PBT ex-OI stepped up to 146.2 (from ~130-131 the prior two comparable quarters). Q4FY26 is a **balancing figure** (auditor Other Matters, N3) so all QoQ-from-Q4 deltas (headline PAT +153%/+243% QoQ) are **base-distorted** by Q4's negative Other Income — do not read QoQ PAT as operational acceleration (F16-b). Implied Q2 FY27 base to hold trajectory: standalone revenue ≥ ~Rs 383 Cr and EBITDA margin ≥ 37-40%.
...
**Data-availability (Reg 33):** Q1 statutory filing is P&L-only. CFO and balance-sheet rows below are taken from the **investor deck** (slides 38, 39, 44) — management-presented, not separately audited this quarter. The full audited cash-flow statement is a **Q2 FY27** item. Rows requiring the statutory balance sheet are marked ND.

| Metric | Prior (Q1 FY26 / Q4 FY26) | Current (Q1 FY27) | Change | Verdict |
|---|---|---|---|---|
| CFO — Consolidated | 161 (Q1FY26, deck L1907) | 163 (L1160/L1907) | +2 (+2% YoY) | Flat YoY; QoQ −44% vs Q4 290 (seasonal, F7/F16-c) |
| CFO — Standalone | 144 (Q1FY26, deck L1972) | 153 (L1292/L1971) | +9 (+6% YoY) | QoQ −47% vs Q4 287 (seasonal) |
| CFO/PAT single-quarter — Consol | 1.05x (161/153.5) | **0.95x** (163/172.2) | −0.10x | Below unity this quarter |
| CFO/PAT single-quarter — Standalone | 0.87x (144/166.0) | **0.87x** (153/176.1) | flat | Below unity (advance-collection timing) |
| CFO/PAT rolling 12m — Consol | 1.46x (FY26 694/475) | **≈1.41x** (rolling 696/493.7) | −0.05x | **Elite band retained (>1.0x)** |
| Capex (PPE+CWIP) — Consol | — | ~0 (deck L1163) | — | Asset-light |
| FCF (CFO − Capex) — Consol | — | ≈163 | — | ≈CFO |
| Working-capital change | ND (no Q1 cash-flow stmt) | ND | ND | Negative-WC model (deferred revenue) |
| Receivable days | ND (subscription/advance model) | ND | ND | n/a — collections are advance |
| Inventory days | ND (n/a) | ND | ND | n/a |
| Payable days | ND | ND | ND | n/a |
| Cash Conversion Cycle | Structurally negative (advance subscription) | Structurally negative | — | Deferred revenue 2,014 Cr consol (L1136) funds operations |
| Deferred Revenue — Consol | 1,965 (Q4FY26, L1136) | **2,014** (L1136) | +49 QoQ; +16% YoY | Forward-revenue visibility building |
| PPE / Fixed Assets — Consol | 40 (Q4FY26, L1122) | 35 (L1122) | −5 | Immaterial |
| Cash & Investments — Consol | 3,280 (Q4FY26, L1128) | **3,553** (L1128) | +273 | Treasury build |
| Strategic Investments — Consol | 763 (Q4FY26, L1130) | 741 (L1130) | −22 | — |
| Capital & Reserves — Consol | 2,400 (Q4FY26, L1134) | **2,220** (L1134) | **−180** | Dividend appropriation (F11-01) |
| Other Liabilities — Consol | 169 (Q4FY26, L1142) | **507** (L1142) | **+338** | **Dividend payable at 30 Jun; ~Rs 340 Cr cash outflow settles Q2 FY27 (F11-01, footnote L1179)** |
| Net Debt / (Net Cash) | Net cash | **Net cash ≈ (3,553)** | — | No borrowings; finance cost Rs 0.5 Cr is lease interest |
| Promoter Pledge | ND | **ND** (deck & filing silent) | — | **Unconfirmed — must obtain (F17-01)** |

**Mandatory questions:**
- **CFO/PAT vs Pillar-2 cash-multiplier band:** Rolling-12m ≈1.41x sits in/above the elite 1.30x band — the Pillar-2 cash multiplier assumption **holds**. The single-quarter dip to 0.87-0.95x is **seasonal** (Q1 collections are the year's weakest; Q4 the strongest, footnotes L1209/L1921/L1983), not structural. Standalone CFO/PAT 0.87x is below unity but explained by the advance-collection calendar; it is **not** a 2-quarter <0.8x red.
- **WC drag structural or growth-induced?** Neither — the model runs **structurally negative** working capital (deferred revenue Rs 2,014 Cr consol is a source, not a use, of cash). If the company stopped growing, WC would stay a cash source. **Cash conversion classification = STRUCTURAL** (negative-WC subscription model), not INDETERMINATE. Per house rule this does not cap the verdict; the missing evidence (full audited Q1 cash-flow statement) is named and is a Q2 item, but the deck-level CFO and rolling ratio are sufficient to classify.
- **CWIP capitalisation:** n/a (asset-light, ~0 capex).
- **Net-debt move:** Net cash grew Rs 273 Cr QoQ to Rs 3,553 Cr **before** the ~Rs 340 Cr dividend payable settles — expect a treasury draw in Q2 FY27 (F11-01). No debt-driven finance-cost tail.
...
The passed Notion thesis gives a destination framework (operating EPS Rs 53→78 over 3 yrs, 30x, ~Rs 3,067 base target, ~13.6% CAGR) rather than an explicit single-quarter Bear/Base/Bull revenue/PAT grid. Mapping this quarter to that path:

| Metric | Thesis reference | Q1 FY27 actual | Lands in |
|---|---|---|---|
...
**Probability re-weighting rule (v1.2):** actuals did **not** land below bear on 2+ key financial metrics (revenue +, margin +, PAT +, cash +). The deterioration is **volume-metric** (buyers/enquiries), not P&L. Therefore the mechanical one-notch probability shift toward Poor is **NOT triggered this quarter**. But this is the **first of a potential 2-quarter watch** on the volume metrics — if buyer/enquiry decline persists into Q2 FY27 alongside any margin give-back, re-weight then.

### 6B. Watchlist / monitoring-checklist scorecard (10 items — every cell line/slide-anchored or ND)
...
### 6C. Thesis-broken trigger check (pre-committed)

| Thesis-broken condition | Threshold | Current reading | FIRED? |
|---|---|---|---|
| EBITDA margin <30% for 2 consecutive quarters | <30% x2 | Standalone 37% (Q4FY26) → 40% (Q1FY27); consol 33%→35% | **NO** — not met, not approaching (10pp buffer) |
| Paying suppliers <209K for 2 consecutive quarters | <209K x2 | Q4FY26 220K → Q1FY27 218K | **NO** — not met (9K buffer); base declining but not near threshold |

**NEITHER pre-committed thesis-break condition is met or approaching** (both carry comfortable buffers). FLAG only — the human decides. The trajectory to watch: paying-supplier base is drifting down (220→218) with negative net adds, so condition #2 is the one to monitor if a further ~9K erodes over the next two quarters.
...
| Hurdle Ratio recheck | HR = (1+EPS CAGR)³ × (Dest PE mid ÷ Current PE) ≥ 1.953 | Current market price not passed to A4; cannot recompute the ratio numerically this run | **DEFER** — recompute at Role 1 refresh with live price; flag that cost Rs 2,015 is above entry-max Rs 1,439 (position underwater vs cost) |

**No pillar changed >10% this quarter → destination PE 30x HELD; no fair-value recompute triggered.** Watch item: two consecutive quarters of volume decline would pressure the Growth Visibility Premium and could compress the destination PE at the next refresh — not this quarter.

🛑 Pillars re-validated; no revision.

---

## STEP 8 — POSITION DECISION (Decision Status verified: HELD → Step 8A branch)
...
- **Revised watch (tightened):** add an interim trim-consideration trigger — **if paying-supplier base prints a THIRD consecutive sequential decline AND active buyers break below 40 Mn** in Q2 FY27, treat as the first of the 2-quarter below-bear volume sequence and prepare a 25% trim for the following quarter. Do not act on it this quarter.
- Add-back trigger: unchanged; entry-max Rs 1,439 / MoS Rs 1,151 stand (no fair-value recompute this quarter).

**8C. Single cleanest metric for next quarter (Q2 FY27):**
**Standalone paying-supplier NET SEQUENTIAL ADDITIONS.** This is the cleanest resolver of the entire bull/bear split: the thesis has quietly become **realization-only** (growth "primarily driven by improvement in realization from paying suppliers", press L88-89) while the supplier base is now shrinking (net −1,852). If net adds turn positive, the volume floor holds and ARPU compounds on a stable base (bull). If the base declines a third straight quarter toward 209K, the model is compounding price on an eroding base (bear) and thesis-break condition #2 comes into range.
- **Bull threshold:** net adds > +2,000 and base > 220K.
- **Bear threshold:** net adds < 0 again (base drifting toward 215K/209K).

🛑 Position decision complete: **HOLD (8A), no change, flagged.**

---

## STEP 8.5 — QUESTIONS FOR MANAGEMENT

Channel: no live concall was available to A4 (webinar recording pending). **Submit all questions as a written IR email**, and prioritise the Top-3 for the pending webinar Q&A if still open. Every A3 FORWARD-SIGNAL and AMBIGUOUS finding maps to at least one question below (from_finding_id in the final column).
...
| 13 | Web-segment liabilities grew +33% YoY vs assets +28% (L398/L392), consistent with a deferred-revenue build. Is the negative-working-capital funding durable at current growth, and how sensitive is it to any slowdown in net supplier adds? | Cash engine durability | Deferred revenue keeps funding ops | Negative-WC weakens as adds fall | F12-02 |
| 14 | Other Liabilities jumped ~Rs 338 Cr QoQ to Rs 507 Cr (L1142) — is this the FY26 dividend payable settling in Q2 FY27 (footnote L1179), and what is the post-payout treasury and buyback plan? | ~Rs 340 Cr Q2 cash outflow / capital-allocation read | Disciplined return, ample treasury remains | Larger-than-expected drawdown | F11-01 |
| 15 | Promoter holding is shown at ~49% (L1798) but pledge status is not disclosed. Please confirm promoter pledge is 0%. | Monitoring item 8 cannot be cleared without this | 0% pledge confirmed | Any pledge = red trigger | F17-01 |
| 16 | The MD/CEO digitally signed both results at ~12:24-12:25 pm, ~2h50m before the board meeting that approved them concluded at 15:15 (L34, L449, L683). Please explain the signing-before-conclusion sequence. | Governance/process-integrity signal | Benign pre-signing pending formal close | Process weakness in approval control | F14-01 |
| 17 | Consolidated PAT rose +243% QoQ (T5) off a Q4 FY26 base of ~Rs 50 Cr. What specifically depressed the Q4 base (negative Other Income of −Rs 34 Cr?), and is the base a balancing figure? | Prevents misreading QoQ as acceleration | Purely treasury MTM base effect | Operational weakness in Q4 masked | F16-b |
...
# SECTION B — CONCALL ANALYSIS (ROLE 5, PARTIAL SUBSTITUTE — NO TRANSCRIPT)

**Scope statement (explicit):** No concall transcript was supplied. The earnings **webinar** was scheduled 21 Jul 2026 17:00 IST with an audio/video recording to follow (press release L160-170); it is not available to A4. Role 5 therefore has **no primary source**. The only management-commentary source this quarter is the **press-release narrative** (CEO quote + highlights), treated below as a **partial Role 5 substitute, clearly labelled, NOT a transcript.** Steps that require a transcript (participant list, Q&A decomposition 4A-4C, promise-vs-delivery scoring, tone-vs-prior-concall, specificity ratio) cannot be run and are marked accordingly. Promise-vs-delivery tracking for this ticker **starts next quarter** once a transcript exists.

### R5-Step 0-2 (from press release narrative only)
- **Participants:** ND (no transcript). CEO Dinesh Agarwal is the sole attributed voice (quote L112-117). Promoter-on-call status ND. CFO Jitin Diwan not quoted.
- **Forward guidance table:** **EMPTY** — the CEO quote is directional sentiment ("we remain confident in our ability to create long-term value", "emphasis on sustainable growth"), with **zero quantified forward statements, zero dated milestones**. Specificity ratio ≈ **0.0** (no quantified forward claims in the narrative). Confidence level of all forward statements: **LOW**.
- **Promise-vs-delivery audit:** Not computable (no prior transcript log; no current commitments). Credibility ratio: **no history — start tracking Q2 FY27.**
- **Management archetype (6E):** cannot be placed on the specificity×credibility grid without a credibility ratio; **provisional read = low-specificity narrative with no dated commitments** (consistent with the deck's guidance silence, F6-01(pres)/F17-04). Flag if the eventual webinar transcript shows a shift toward hyper-specific guidance (Overpromiser watch).

### R5-Step 5 — New information / what was NOT discussed (from filing + deck + release)
| Item | Type | Material? | Thesis impact |
|---|---|---|---|
| IndiaMART Finance Ltd WOS approved | New entity / strategic (lending) | YES | New perimeter; optionality + risk (F6-01) |
| ~Rs 340 Cr dividend payable settling Q2 | Capital allocation | YES | Q2 treasury draw (F11-01) |
| Cause of active-buyer/enquiry decline | **NOT discussed** | YES | AMBER→RED silence (F17-03) |
| ~50% SOM saturation (admitted Q4FY26) | **NOT discussed** | YES | Silence on a prior admission (F17-03) |
...
ledger_reconciliation:
  ...
  slides: 69
  all_reviewed: true
  a3_findings_incorporated: ["F2-01","F4-01","F6-01","F6-02","F7-01","F12-01","F12-02","F13-01","F14-01","F14-02","F15-01","F15-02","F1-01p","F6-01p","F7-01p","F10-01","F11-01","F11-02","F16-01","F16-02","F16-03","F16-04","F16-05","F17-01","F17-02","F17-03","F17-04","F1-a","F16-a","F16-b","F16-c","F17-a","F17-b","F17-c","F17-d"]
protocol_verdict: "PROCEED WITH FLAGS"
cash_conversion: "structural"
decision_status_verified: "HELD (2% position)"
position_branch: "8A"
sc_gap_pat_pct:
  - {period: "Q1 FY26", gap_pct: 7.5}
  - {period: "Q4 FY26", gap_pct: 27.9}
  - {period: "Q1 FY27", gap_pct: 2.2}
  - {period: "FY26", gap_pct: 9.6}
questions_for_management:
  ...
  - {q: "Durability of negative-WC funding as web liabilities +33% outpace assets +28%", from_finding_id: "F12-02"}
  - {q: "~Rs 338 Cr Other-Liabilities jump = dividend payable; Q2 cash outflow and buyback plan", from_finding_id: "F11-01"}
  - {q: "Confirm promoter pledge is 0%", from_finding_id: "F17-01"}
  - {q: "MD/CEO signed results ~2h50m before board meeting concluded - explain sequence", from_finding_id: "F14-01"}
  - {q: "What depressed the Q4 FY26 base driving +243% QoQ PAT", from_finding_id: "F16-b"}
