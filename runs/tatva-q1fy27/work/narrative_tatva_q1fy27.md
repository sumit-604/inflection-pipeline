...
Plain-language operator brief. It translates the combined Role 4 + Role 5 review and adds no new number; every figure here already appears in a table in the review with its source. This run covers both documents: the June-quarter results and the earnings call held the same day.
