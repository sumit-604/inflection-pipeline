...
- 7:00 at home: breakfast with Maa, pocket money, pack a tiffin.
- 7:30 the school bus from the Shanti Nagar stop (or walk, crossing at the zebra).
- 8:00 assembly by the flag: the anthem, a thought for the day, one question.
- Three classes a day from Maths, Science, English, EVS and Computer, then
  lunch and games. Science is taught in the Science Lab and Computer in the
  Computer Room; the other subjects in your classroom. A period starts when
  you sit at your desk or bench. The teacher asks three questions; raise your hand for 2 marks
  (1 with a hint), or let a classmate answer. Homework is set every period.
- Lunch on the benches with friends: eat or share the tiffin, chat, help a
  friend with a doubt, buy at the canteen with real bills and cash.
- Games with Coach Vikram: a different sport every day. Football on the
  field; cricket, running, basketball, badminton, kho-kho and skipping as
  timing games, five tries, one mark each.
- The bus home, homework at the study desk, dinner with Papa and Maa, sleep.
...
- Chat box: press T near anyone, or the speech-bubble button in a dialogue,
  and type what you want to say. Replies answer what you typed: sums are
  worked out, questions about the person (name, age, home, job, likes) come
