COPY THESE FIVE FILES HERE FROM YOUR CLAUDE.AI PROJECT BEFORE THE
...
retired). Stage 11 injects all three Section 1B layers; where they
overlap, v3.6 governs the items it names, then v3.5.1, then v3.3.
