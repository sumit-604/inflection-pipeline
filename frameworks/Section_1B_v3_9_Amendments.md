...
*RECONCILIATION NOTE (07-Sep-2026): the E2E amendment set was drafted as "Amendments 20-24, v3.9" by a review session (Fable 5.1) that did not know v3.9 / Amendment 20 (the relative valuation cross-check) already existed in the repo. On operator ruling the two sets are merged into one reissued v3.9. The E2E amendments are renumbered 21-25; the relative valuation cross-check keeps Amendment 20. Every internal cross-reference is renumbered to match. Framework amendments and run outputs travel on SEPARATE branches and PRs per team-workflow rules.*
